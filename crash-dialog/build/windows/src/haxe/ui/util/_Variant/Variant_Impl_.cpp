...
HX_LOCAL_STACK_FRAME(_hx_pos_6af1edf198e87d95_523_containsOnlyDigits,"haxe.ui.util._Variant.Variant_Impl_","containsOnlyDigits",0x58bb1268,"haxe.ui.util._Variant.Variant_Impl_.containsOnlyDigits","haxe/ui/util/Variant.hx",523,0x091cea34)
HX_LOCAL_STACK_FRAME(_hx_pos_6af1edf198e87d95_541_toDynamic,"haxe.ui.util._Variant.Variant_Impl_","toDynamic",0xb59faf6d,"haxe.ui.util._Variant.Variant_Impl_.toDynamic","haxe/ui/util/Variant.hx",541,0x091cea34)
namespace haxe{
namespace ui{
namespace util{
namespace _Variant{
...
HXDLIN(  40)				return ::Std_obj::string(s);
            			...
            			break;
            			case (int)8: {
HXLINE(  41)				 ::hx::widgets::Bitmap s = this1->_hx_getObject(0).StaticCast<  ::hx::widgets::Bitmap >();
...
HXDLIN(  87)				return ::Std_obj::_hx_int(s);
            			...
            			break;
            			default:{
HXLINE(  88)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Variant Type Error ",c3,3f,ed,59) + ::Std_obj::string(this1))));
            			}
            		}
HXLINE(  85)		return 0;
            	}
...
HXLINE( 507)							if (::Std_obj::isOfType(r,::hx::ClassOf< ::Date >())) {
HXLINE( 508)								v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDate(::hx::TCast<  ::Date >::cast(r));
            							}
            							else {
HXLINE( 509)								if (::Std_obj::isOfType(r,::hx::ClassOf< ::hx::widgets::Bitmap >())) {
HXLINE( 510)									v = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromImageData(::hx::TCast<  ::hx::widgets::Bitmap >::cast(r));
            								}
            								else {
HXLINE( 515)									v = r;
            								}
...
bool Variant_Impl__obj::containsOnlyDigits( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_6af1edf198e87d95_523_containsOnlyDigits)
HXLINE( 524)		bool _hx_tmp;
HXDLIN( 524)		bool _hx_tmp1;
HXDLIN( 524)		bool _hx_tmp2;
HXDLIN( 524)		if (!(::Std_obj::isOfType(s,::hx::ClassOf< ::haxe::ui::core::Component >()))) {
HXLINE( 524)			_hx_tmp2 = ::Std_obj::isOfType(s,::hx::ClassOf< ::hx::widgets::Bitmap >());
            		}
            		else {
HXLINE( 524)			_hx_tmp2 = true;
            		}
HXDLIN( 524)		if (!(_hx_tmp2)) {
HXLINE( 524)			_hx_tmp1 = ::Std_obj::isOfType(s,::hx::ArrayBase::__mClass);
            		}
            		else {
HXLINE( 524)			_hx_tmp1 = true;
            		}
HXDLIN( 524)		if (!(_hx_tmp1)) {
HXLINE( 524)			_hx_tmp = ::Std_obj::isOfType(s,::hx::ClassOf< ::haxe::ui::data::DataSource >());
            		}
            		else {
...
HXLINE( 527)		bool _hx_tmp3;
HXDLIN( 527)		if (!(::Std_obj::isOfType(s,::hx::ClassOf< int >()))) {
HXLINE( 527)			_hx_tmp3 = ::Std_obj::isOfType(s,::hx::ClassOf< ::Float >());
            		}
            		else {
HXLINE( 527)			_hx_tmp3 = true;
            		}
HXDLIN( 527)		if (_hx_tmp3) {
HXLINE( 528)			return true;
            		}
HXLINE( 531)		::String t = ::Std_obj::string(s);
HXLINE( 532)		{
HXLINE( 532)			int _g = 0;
HXDLIN( 532)			int _g1 = t.length;
HXDLIN( 532)			while((_g < _g1)){
HXLINE( 532)				_g = (_g + 1);
HXDLIN( 532)				int i = (_g - 1);
HXLINE( 533)				::String c = t.charAt(i);
HXLINE( 534)				bool _hx_tmp;
HXDLIN( 534)				bool _hx_tmp1;
HXDLIN( 534)				bool _hx_tmp2;
HXDLIN( 534)				bool _hx_tmp3;
HXDLIN( 534)				bool _hx_tmp4;
HXDLIN( 534)				bool _hx_tmp5;
HXDLIN( 534)				bool _hx_tmp6;
HXDLIN( 534)				bool _hx_tmp7;
HXDLIN( 534)				bool _hx_tmp8;
HXDLIN( 534)				bool _hx_tmp9;
HXDLIN( 534)				bool _hx_tmp10;
HXDLIN( 534)				if ((c != HX_("0",30,00,00,00))) {
HXLINE( 534)					_hx_tmp10 = (c != HX_("1",31,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp10 = false;
            				}
HXDLIN( 534)				if (_hx_tmp10) {
HXLINE( 534)					_hx_tmp9 = (c != HX_("2",32,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp9 = false;
            				}
HXDLIN( 534)				if (_hx_tmp9) {
HXLINE( 534)					_hx_tmp8 = (c != HX_("3",33,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp8 = false;
            				}
HXDLIN( 534)				if (_hx_tmp8) {
HXLINE( 534)					_hx_tmp7 = (c != HX_("4",34,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp7 = false;
            				}
HXDLIN( 534)				if (_hx_tmp7) {
HXLINE( 534)					_hx_tmp6 = (c != HX_("5",35,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp6 = false;
            				}
HXDLIN( 534)				if (_hx_tmp6) {
HXLINE( 534)					_hx_tmp5 = (c != HX_("6",36,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp5 = false;
            				}
HXDLIN( 534)				if (_hx_tmp5) {
HXLINE( 534)					_hx_tmp4 = (c != HX_("7",37,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp4 = false;
            				}
HXDLIN( 534)				if (_hx_tmp4) {
HXLINE( 534)					_hx_tmp3 = (c != HX_("8",38,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp3 = false;
            				}
HXDLIN( 534)				if (_hx_tmp3) {
HXLINE( 534)					_hx_tmp2 = (c != HX_("9",39,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp2 = false;
            				}
HXDLIN( 534)				if (_hx_tmp2) {
HXLINE( 534)					_hx_tmp1 = (c != HX_(".",2e,00,00,00));
            				}
            				else {
HXLINE( 534)					_hx_tmp1 = false;
            				}
HXDLIN( 534)				if (_hx_tmp1) {
HXLINE( 534)					_hx_tmp = (c != HX_("-",2d,00,00,00));
            				}
            				else {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Variant_Impl__obj,containsOnlyDigits,return )
 ...
 ::Dynamic Variant_Impl__obj::toDynamic( ::haxe::ui::util::VariantType v){
            	HX_STACKFRAME(&_hx_pos_6af1edf198e87d95_541_toDynamic)
HXLINE( 542)		 ::Dynamic d = v;
HXLINE( 543)		if (::hx::IsNotNull( v )) {
HXLINE( 544)			switch((int)(v->_hx_getIndex())){
            				case (int)0: {
HXLINE( 545)					int y = v->_hx_getInt(0);
HXDLIN( 545)					d = y;
            				}
            				break;
            				case (int)1: {
HXLINE( 546)					Float y = v->_hx_getFloat(0);
HXDLIN( 546)					d = y;
            				}
            				break;
            				case (int)2: {
HXLINE( 547)					::String y = v->_hx_getString(0);
HXDLIN( 547)					d = y;
            				}
            				break;
            				case (int)3: {
HXLINE( 548)					bool y = v->_hx_getBool(0);
HXDLIN( 548)					d = y;
            				}
            				break;
            				case (int)4: {
HXLINE( 549)					::cpp::VirtualArray y = v->_hx_getObject(0).StaticCast< ::cpp::VirtualArray >();
HXDLIN( 549)					d = y;
            				}
            				break;
            				case (int)5: {
HXLINE( 551)					 ::haxe::ui::data::DataSource y = v->_hx_getObject(0).StaticCast<  ::haxe::ui::data::DataSource >();
HXDLIN( 551)					d = y;
            				}
            				break;
            				case (int)6: {
HXLINE( 550)					 ::haxe::ui::core::Component y = v->_hx_getObject(0).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 550)					d = y;
            				}
            				break;
            				case (int)7: {
HXLINE( 552)					 ::Date y = v->_hx_getObject(0).StaticCast<  ::Date >();
HXDLIN( 552)					d = y;
            				}
            				break;
            				case (int)8: {
HXLINE( 553)					 ::hx::widgets::Bitmap y = v->_hx_getObject(0).StaticCast<  ::hx::widgets::Bitmap >();
HXDLIN( 553)					d = y;
            				}
            				break;
            			}
