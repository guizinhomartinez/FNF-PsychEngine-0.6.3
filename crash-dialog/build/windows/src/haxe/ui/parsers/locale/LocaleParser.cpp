...
HX_LOCAL_STACK_FRAME(_hx_pos_d63ac6a12e620884_29_defaultParsers,"haxe.ui.parsers.locale.LocaleParser","defaultParsers",0xa8fc10c0,"haxe.ui.parsers.locale.LocaleParser.defaultParsers","haxe/ui/parsers/locale/LocaleParser.hx",29,0x8f81ecdd)
HX_LOCAL_STACK_FRAME(_hx_pos_d63ac6a12e620884_34_register,"haxe.ui.parsers.locale.LocaleParser","register",0xa5a6ef70,"haxe.ui.parsers.locale.LocaleParser.register","haxe/ui/parsers/locale/LocaleParser.hx",34,0x8f81ecdd)
namespace haxe{
namespace ui{
namespace parsers{
namespace locale{
...
void LocaleParser_obj::defaultParsers(){
            	HX_STACKFRAME(&_hx_pos_d63ac6a12e620884_29_defaultParsers)
HXLINE(  30)		::haxe::ui::parsers::locale::LocaleParser_obj::_hx_register(HX_("properties",f3,fb,0e,61),::hx::ClassOf< ::haxe::ui::parsers::locale::PropertiesParser >());
HXLINE(  31)		::haxe::ui::parsers::locale::LocaleParser_obj::_hx_register(HX_("po",ff,61,00,00),::hx::ClassOf< ::haxe::ui::parsers::locale::PoParser >());
            	}
...
void LocaleParser_obj::_hx_register(::String extension,::hx::Class cls){
            	HX_GC_STACKFRAME(&_hx_pos_d63ac6a12e620884_34_register)
HXLINE(  35)		if (::hx::IsNull( ::haxe::ui::parsers::locale::LocaleParser_obj::_parsers )) {
HXLINE(  36)			::haxe::ui::parsers::locale::LocaleParser_obj::_parsers =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
HXLINE(  38)		::haxe::ui::parsers::locale::LocaleParser_obj::_parsers->set(extension,cls);
            	}
