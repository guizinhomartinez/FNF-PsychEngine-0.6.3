...
HX_LOCAL_STACK_FRAME(_hx_pos_186b1b74991ba353_20_createChildren,"haxe.ui.Preloader","createChildren",0xe6673285,"haxe.ui.Preloader.createChildren","haxe/ui/Preloader.hx",20,0xe36684da)
HX_LOCAL_STACK_FRAME(_hx_pos_186b1b74991ba353_28_validateComponentLayout,"haxe.ui.Preloader","validateComponentLayout",0x0689dfe7,"haxe.ui.Preloader.validateComponentLayout","haxe/ui/Preloader.hx",28,0xe36684da)
HX_LOCAL_STACK_FRAME(_hx_pos_186b1b74991ba353_39_progress,"haxe.ui.Preloader","progress",0x70aa3657,"haxe.ui.Preloader.progress","haxe/ui/Preloader.hx",39,0xe36684da)
HX_LOCAL_STACK_FRAME(_hx_pos_186b1b74991ba353_56_increment,"haxe.ui.Preloader","increment",0x76d69c45,"haxe.ui.Preloader.increment","haxe/ui/Preloader.hx",56,0xe36684da)
HX_LOCAL_STACK_FRAME(_hx_pos_186b1b74991ba353_60_complete,"haxe.ui.Preloader","complete",0x6a473f63,"haxe.ui.Preloader.complete","haxe/ui/Preloader.hx",60,0xe36684da)
HX_LOCAL_STACK_FRAME(_hx_pos_3272413211a8f5fe_442_registerBehaviours,"haxe.ui.Preloader","registerBehaviours",0x45539f03,"haxe.ui.Preloader.registerBehaviours","haxe/ui/macros/Macros.hx",442,0x27866361)
HX_LOCAL_STACK_FRAME(_hx_pos_7d3e1c8290b31e6a_565_cloneComponent,"haxe.ui.Preloader","cloneComponent",0x4a1983ca,"haxe.ui.Preloader.cloneComponent","haxe/ui/macros/helpers/ClassBuilder.hx",565,0x8cdaad7b)
HX_LOCAL_STACK_FRAME(_hx_pos_3272413211a8f5fe_423_self,"haxe.ui.Preloader","self",0xcd8cad36,"haxe.ui.Preloader.self","haxe/ui/macros/Macros.hx",423,0x27866361)
namespace haxe{
namespace ui{
...
HXLINE(  17)		this->set_styleNames(HX_("default-background",3a,3b,23,a8));
            	}
...
void Preloader_obj::createChildren(){
            	HX_GC_STACKFRAME(&_hx_pos_186b1b74991ba353_20_createChildren)
HXLINE(  21)		 ::haxe::ui::components::Label label =  ::haxe::ui::components::Label_obj::__alloc( HX_CTX );
HXLINE(  22)		label->set_text(HX_("Loading",5c,f6,43,d6));
HXLINE(  23)		label->set_verticalAlign(HX_("center",d5,25,db,05));
HXLINE(  24)		label->set_horizontalAlign(HX_("center",d5,25,db,05));
HXLINE(  25)		this->addComponent(label);
            	}


bool Preloader_obj::validateComponentLayout(){
            	HX_STACKFRAME(&_hx_pos_186b1b74991ba353_28_validateComponentLayout)
HXLINE(  29)		bool b = this->super::validateComponentLayout();
HXLINE(  30)		bool _hx_tmp;
HXDLIN(  30)		if ((this->get_actualComponentWidth() > 0)) {
HXLINE(  30)			_hx_tmp = (this->get_actualComponentHeight() > 0);
            		}
            		else {
...
void Preloader_obj::progress(int current,int max){
            	HX_STACKFRAME(&_hx_pos_186b1b74991ba353_39_progress)
HXLINE(  40)		this->_current = current;
HXLINE(  41)		this->_max = max;
HXLINE(  43)		if ((current > 0)) {
HXLINE(  44)			 ::haxe::ui::components::Label label = ( ( ::haxe::ui::components::Label)(this->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::Label >(),null(),null())) );
HXLINE(  45)			if (::hx::IsNotNull( label )) {
HXLINE(  46)				::String text = label->get_text();
HXLINE(  47)				if (::StringTools_obj::endsWith(text,HX_("....",80,e0,8a,1e))) {
HXLINE(  48)					text = HX_("Loading",5c,f6,43,d6);
            				}
HXLINE(  50)				label->set_text(text);
            			}
            		}
            	}
...
void Preloader_obj::increment(){
            	HX_STACKFRAME(&_hx_pos_186b1b74991ba353_56_increment)
HXDLIN(  56)		this->progress((this->_current + 1),this->_max);
            	}
...
void Preloader_obj::complete(){
            	HX_STACKFRAME(&_hx_pos_186b1b74991ba353_60_complete)
HXDLIN(  60)		::haxe::ui::core::Screen_obj::get_instance()->removeComponent(::hx::ObjectPtr<OBJ_>(this),null());
            	}
...
void Preloader_obj::registerBehaviours(){
            	HX_STACKFRAME(&_hx_pos_3272413211a8f5fe_442_registerBehaviours)
HXDLIN( 442)		this->super::registerBehaviours();
            	}


 ::haxe::ui::core::ComponentContainer Preloader_obj::cloneComponent(){
            	HX_STACKFRAME(&_hx_pos_7d3e1c8290b31e6a_565_cloneComponent)
HXLINE( 371)		 ::haxe::ui::Preloader c = ( ( ::haxe::ui::Preloader)(this->super::cloneComponent()) );
HXLINE( 386)		{
...
HXLINE( 395)		return c;
 ...
 ::haxe::ui::core::ComponentContainer Preloader_obj::self(){
            	HX_GC_STACKFRAME(&_hx_pos_3272413211a8f5fe_423_self)
HXDLIN( 423)		return  ::haxe::ui::Preloader_obj::__alloc( HX_CTX );
            	}
