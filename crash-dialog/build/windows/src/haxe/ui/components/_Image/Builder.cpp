...
HX_DEFINE_STACK_FRAME(_hx_pos_fd90e646f9611825_297_new,"haxe.ui.components._Image.Builder","new",0x572d4a81,"haxe.ui.components._Image.Builder.new","haxe/ui/components/Image.hx",297,0xeed4974a)
HX_DEFINE_STACK_FRAME(_hx_pos_fd90e646f9611825_293_new,"haxe.ui.components._Image.Builder","new",0x572d4a81,"haxe.ui.components._Image.Builder.new","haxe/ui/components/Image.hx",293,0xeed4974a)
HX_LOCAL_STACK_FRAME(_hx_pos_fd90e646f9611825_304_applyStyle,"haxe.ui.components._Image.Builder","applyStyle",0xbf999ce2,"haxe.ui.components._Image.Builder.applyStyle","haxe/ui/components/Image.hx",304,0xeed4974a)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::Image image){
            		...
            		void _hx_run( ::haxe::ui::events::UIEvent _){
            			HX_STACKFRAME(&_hx_pos_fd90e646f9611825_297_new)
HXLINE( 297)			if (::hx::IsNotNull( _gthis->_image->parentComponent )) {
HXLINE( 298)				 ::haxe::ui::core::Component _this = _gthis->_image->parentComponent;
HXDLIN( 298)				bool _hx_tmp;
HXDLIN( 298)				if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 298)					_hx_tmp = (_this->_layoutLocked == true);
            				}
            				else {
HXLINE( 298)					_hx_tmp = true;
            				}
HXDLIN( 298)				if (!(_hx_tmp)) {
HXLINE( 298)					_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            				}
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_fd90e646f9611825_293_new)
HXDLIN( 293)		 ::haxe::ui::components::_Image::Builder _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 294)		super::__construct(image);
HXLINE( 295)		this->_image = image;
HXLINE( 296)		this->_image->registerEvent(HX_("shown",d1,88,27,7c), ::Dynamic(new _hx_Closure_0(_gthis)),null());
            	}
...
void Builder_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_fd90e646f9611825_304_applyStyle)
HXDLIN( 304)		if (::hx::IsNotNull( style->resource )) {
HXLINE( 305)			this->_image->set_resource(style->resource);
            		}
            	}
