...
HX_DEFINE_STACK_FRAME(_hx_pos_8d3364b1bfc8293e_123_new,"haxe.ui.components._Label.TextBehaviour","new",0xc370ad8f,"haxe.ui.components._Label.TextBehaviour.new","haxe/ui/components/Label.hx",123,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_8d3364b1bfc8293e_124_validateData,"haxe.ui.components._Label.TextBehaviour","validateData",0x26eedad1,"haxe.ui.components._Label.TextBehaviour.validateData","haxe/ui/components/Label.hx",124,0xeb990e51)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_8d3364b1bfc8293e_123_new)
...
void TextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_8d3364b1bfc8293e_124_validateData)
HXLINE( 125)		 ::haxe::ui::styles::Style _hx_tmp = this->_component->getTextDisplay()->get_textStyle();
HXDLIN( 125)		if (::hx::IsInstanceNotEq( _hx_tmp,this->_component->get_style() )) {
HXLINE( 126)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 126)			_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN( 126)			_this->_style = null();
            		}
HXLINE( 128)		 ::haxe::ui::core::TextDisplay _hx_tmp1 = this->_component->getTextDisplay();
HXDLIN( 128)		::String _hx_tmp2;
HXDLIN( 128)		if (::hx::IsNull( this->_value )) {
HXLINE( 128)			_hx_tmp2 = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE( 128)			_hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
HXDLIN( 128)		_hx_tmp1->set_text((HX_("",00,00,00,00) + _hx_tmp2));
HXLINE( 129)		 ::haxe::ui::core::Component _hx_tmp3 = this->_component;
HXDLIN( 129)		_hx_tmp3->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            	}
