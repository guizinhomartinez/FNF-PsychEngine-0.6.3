...
HX_DEFINE_STACK_FRAME(_hx_pos_3a1374baa336e965_151_new,"haxe.ui.components._Label.Builder","new",0x81ab3a9a,"haxe.ui.components._Label.Builder.new","haxe/ui/components/Label.hx",151,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_3a1374baa336e965_157_applyStyle,"haxe.ui.components._Label.Builder","applyStyle",0x6fa6d1e9,"haxe.ui.components._Label.Builder.applyStyle","haxe/ui/components/Label.hx",157,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_3a1374baa336e965_171_get_isComponentClipped,"haxe.ui.components._Label.Builder","get_isComponentClipped",0xe875481b,"haxe.ui.components._Label.Builder.get_isComponentClipped","haxe/ui/components/Label.hx",171,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_3a1374baa336e965_168_isHtml,"haxe.ui.components._Label.Builder","isHtml",0x487a907b,"haxe.ui.components._Label.Builder.isHtml","haxe/ui/components/Label.hx",168,0xeb990e51)
namespace haxe{
namespace ui{
...
void Builder_obj::__construct( ::haxe::ui::components::Label label){
            	HX_STACKFRAME(&_hx_pos_3a1374baa336e965_151_new)
HXLINE( 152)		super::__construct(label);
HXLINE( 153)		this->_label = label;
            	}
...
void Builder_obj::applyStyle( ::haxe::ui::styles::Style style){
            	HX_STACKFRAME(&_hx_pos_3a1374baa336e965_157_applyStyle)
HXDLIN( 157)		if ((this->_label->hasTextDisplay() == true)) {
HXLINE( 158)			this->_label->getTextDisplay()->set_textStyle(style);
HXLINE( 160)			bool _hx_tmp;
HXDLIN( 160)			bool _hx_tmp1;
HXDLIN( 160)			bool _hx_tmp2;
HXDLIN( 160)			if ((style->contentType != HX_("auto",6f,df,76,40))) {
HXLINE( 160)				_hx_tmp2 = (style->contentType == HX_("html",6b,95,16,45));
            			}
            			else {
HXLINE( 160)				_hx_tmp2 = true;
            			}
HXDLIN( 160)			if (_hx_tmp2) {
HXLINE( 160)				_hx_tmp1 = this->_label->getTextDisplay()->get_supportsHtml();
            			}
            			else {
HXLINE( 160)				_hx_tmp1 = false;
            			}
HXDLIN( 160)			if (_hx_tmp1) {
HXLINE( 160)				::String v = ::Std_obj::string(this->_component->get_text());
HXDLIN( 160)				if (::hx::IsNull( v )) {
HXLINE( 160)					_hx_tmp = false;
            				}
            				else {
HXLINE( 160)					_hx_tmp = (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            				}
            			}
            			else {
HXLINE( 160)				_hx_tmp = false;
...
HXLINE( 161)				 ::haxe::ui::components::Label _hx_tmp = this->_label;
HXDLIN( 161)				_hx_tmp->set_htmlText(this->_label->get_text());
            			}
            		}
            	}
...
bool Builder_obj::get_isComponentClipped(){
            	HX_STACKFRAME(&_hx_pos_3a1374baa336e965_171_get_isComponentClipped)
HXLINE( 172)		 ::haxe::ui::geom::Rectangle componentClipRect = this->_component->get_componentClipRect();
HXLINE( 173)		if (::hx::IsNull( componentClipRect )) {
HXLINE( 174)			return false;
            		}
HXLINE( 177)		Float _hx_tmp = this->_label->getTextDisplay()->measureTextWidth();
HXDLIN( 177)		return (_hx_tmp > componentClipRect->width);
            	}


bool Builder_obj::isHtml(::String v){
            	HX_STACKFRAME(&_hx_pos_3a1374baa336e965_168_isHtml)
HXDLIN( 168)		if (::hx::IsNull( v )) {
HXDLIN( 168)			return false;
            		}
            		else {
HXDLIN( 168)			return (v.indexOf(HX_("<font ",b5,5d,fb,01),null()) != -1);
            		}
HXDLIN( 168)		return false;
            	}
