...
HX_DEFINE_STACK_FRAME(_hx_pos_783f83cb03bee32a_134_new,"haxe.ui.components._Label.HtmlTextBehaviour","new",0x466ffa24,"haxe.ui.components._Label.HtmlTextBehaviour.new","haxe/ui/components/Label.hx",134,0xeb990e51)
HX_LOCAL_STACK_FRAME(_hx_pos_783f83cb03bee32a_135_validateData,"haxe.ui.components._Label.HtmlTextBehaviour","validateData",0xd2fdd39c,"haxe.ui.components._Label.HtmlTextBehaviour.validateData","haxe/ui/components/Label.hx",135,0xeb990e51)
namespace haxe{
namespace ui{
...
void HtmlTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_783f83cb03bee32a_134_new)
...
void HtmlTextBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_783f83cb03bee32a_135_validateData)
HXLINE( 136)		 ::haxe::ui::styles::Style _hx_tmp = this->_component->getTextDisplay()->get_textStyle();
HXDLIN( 136)		if (::hx::IsInstanceNotEq( _hx_tmp,this->_component->get_style() )) {
HXLINE( 137)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 137)			_this->invalidateComponent(HX_("style",31,a5,1d,84),false);
HXDLIN( 137)			_this->_style = null();
            		}
HXLINE( 139)		 ::haxe::ui::core::TextDisplay _hx_tmp1 = this->_component->getTextDisplay();
HXDLIN( 139)		::String _hx_tmp2;
HXDLIN( 139)		if (::hx::IsNull( this->_value )) {
HXLINE( 139)			_hx_tmp2 = HX_("null",87,9e,0e,49);
            		}
            		else {
HXLINE( 139)			_hx_tmp2 = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
HXDLIN( 139)		_hx_tmp1->set_htmlText((HX_("",00,00,00,00) + _hx_tmp2));
HXLINE( 140)		 ::haxe::ui::core::Component _hx_tmp3 = this->_component;
HXDLIN( 140)		_hx_tmp3->dispatch( ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null()));
            	}
