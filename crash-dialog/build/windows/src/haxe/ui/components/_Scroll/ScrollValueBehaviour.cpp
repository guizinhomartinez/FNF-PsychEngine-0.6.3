...
HX_DEFINE_STACK_FRAME(_hx_pos_583c58053f37acea_201_new,"haxe.ui.components._Scroll.ScrollValueBehaviour","new",0xb7f1f673,"haxe.ui.components._Scroll.ScrollValueBehaviour.new","haxe/ui/components/Scroll.hx",201,0x330a6dea)
HX_LOCAL_STACK_FRAME(_hx_pos_583c58053f37acea_202_set,"haxe.ui.components._Scroll.ScrollValueBehaviour","set",0xb7f5c1b5,"haxe.ui.components._Scroll.ScrollValueBehaviour.set","haxe/ui/components/Scroll.hx",202,0x330a6dea)
HX_LOCAL_STACK_FRAME(_hx_pos_583c58053f37acea_211_validateData,"haxe.ui.components._Scroll.ScrollValueBehaviour","validateData",0x4e57556d,"haxe.ui.components._Scroll.ScrollValueBehaviour.validateData","haxe/ui/components/Scroll.hx",211,0x330a6dea)
namespace haxe{
namespace ui{
...
void ScrollValueBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_583c58053f37acea_201_new)
HXDLIN( 201)		super::__construct(component);
            	}
...
void ScrollValueBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_583c58053f37acea_202_set)
HXLINE( 203)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->get())) {
HXLINE( 204)			return;
            		}
HXLINE( 207)		this->super::set(value);
HXLINE( 208)		{
HXLINE( 208)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 208)			bool _hx_tmp;
HXDLIN( 208)			if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 208)				_hx_tmp = (_this->_layoutLocked == true);
            			}
            			else {
...
void ScrollValueBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_583c58053f37acea_211_validateData)
HXLINE( 212)		 ::haxe::ui::components::Scroll scroll = ::hx::TCast<  ::haxe::ui::components::Scroll >::cast(this->_component);
HXLINE( 213)		Float pos = scroll->get_pos();
HXLINE( 214)		Float min = scroll->get_min();
HXLINE( 215)		Float max = scroll->get_max();
HXLINE( 216)		if ((pos < min)) {
HXLINE( 217)			scroll->set_pos(min);
            		}
            		else {
HXLINE( 218)			if ((pos > max)) {
HXLINE( 219)				scroll->set_pos(max);
            			}
            		}
HXLINE( 222)		 ::haxe::ui::events::UIEvent changeEvent =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null());
HXLINE( 223)		scroll->dispatch(changeEvent);
HXLINE( 225)		 ::haxe::ui::events::ScrollEvent scrollEvent =  ::haxe::ui::events::ScrollEvent_obj::__alloc( HX_CTX ,HX_("scrollscroll",da,b7,92,6a));
HXLINE( 226)		scroll->dispatch(scrollEvent);
            	}
