...
HX_DEFINE_STACK_FRAME(_hx_pos_9df401ee04fcc65c_231_new,"haxe.ui.components._Scroll.ScrollMinMaxBehaviour","new",0x4b78e988,"haxe.ui.components._Scroll.ScrollMinMaxBehaviour.new","haxe/ui/components/Scroll.hx",231,0x330a6dea)
HX_LOCAL_STACK_FRAME(_hx_pos_9df401ee04fcc65c_232_set,"haxe.ui.components._Scroll.ScrollMinMaxBehaviour","set",0x4b7cb4ca,"haxe.ui.components._Scroll.ScrollMinMaxBehaviour.set","haxe/ui/components/Scroll.hx",232,0x330a6dea)
HX_LOCAL_STACK_FRAME(_hx_pos_9df401ee04fcc65c_241_validateData,"haxe.ui.components._Scroll.ScrollMinMaxBehaviour","validateData",0x8ff5d7b8,"haxe.ui.components._Scroll.ScrollMinMaxBehaviour.validateData","haxe/ui/components/Scroll.hx",241,0x330a6dea)
namespace haxe{
namespace ui{
...
void ScrollMinMaxBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_9df401ee04fcc65c_231_new)
...
void ScrollMinMaxBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_9df401ee04fcc65c_232_set)
HXLINE( 233)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->get())) {
HXLINE( 234)			return;
            		}
HXLINE( 237)		this->super::set(value);
HXLINE( 238)		{
HXLINE( 238)			 ::haxe::ui::core::Component _this = this->_component;
HXDLIN( 238)			bool _hx_tmp;
HXDLIN( 238)			if (::hx::IsNotNull( _this->_layout )) {
HXLINE( 238)				_hx_tmp = (_this->_layoutLocked == true);
            			}
            			else {
HXLINE( 238)				_hx_tmp = true;
            			}
HXDLIN( 238)			if (!(_hx_tmp)) {
HXLINE( 238)				_this->invalidateComponent(HX_("layout",aa,ae,b8,58),false);
            			}
            		}
            	}
...
void ScrollMinMaxBehaviour_obj::validateData(){
            	HX_GC_STACKFRAME(&_hx_pos_9df401ee04fcc65c_241_validateData)
HXLINE( 242)		 ::haxe::ui::components::Scroll scroll = ::hx::TCast<  ::haxe::ui::components::Scroll >::cast(this->_component);
HXLINE( 243)		Float pos = scroll->get_pos();
HXLINE( 244)		Float min = scroll->get_min();
HXLINE( 245)		Float max = scroll->get_max();
HXLINE( 246)		if ((pos < min)) {
HXLINE( 247)			scroll->set_pos(min);
            		}
            		else {
HXLINE( 248)			if ((pos > max)) {
HXLINE( 249)				scroll->set_pos(max);
            			}
            		}
HXLINE( 252)		 ::haxe::ui::events::UIEvent changeEvent =  ::haxe::ui::events::UIEvent_obj::__alloc( HX_CTX ,HX_("change",70,91,72,b7),null(),null());
HXLINE( 253)		scroll->dispatch(changeEvent);
            	}
