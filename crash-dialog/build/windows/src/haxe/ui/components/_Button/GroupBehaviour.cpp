...
HX_DEFINE_STACK_FRAME(_hx_pos_33100ef250bd0142_308_new,"haxe.ui.components._Button.GroupBehaviour","new",0x422d79b3,"haxe.ui.components._Button.GroupBehaviour.new","haxe/ui/components/Button.hx",308,0x45086125)
HX_LOCAL_STACK_FRAME(_hx_pos_33100ef250bd0142_310_validateData,"haxe.ui.components._Button.GroupBehaviour","validateData",0x52b16a2d,"haxe.ui.components._Button.GroupBehaviour.validateData","haxe/ui/components/Button.hx",310,0x45086125)
namespace haxe{
namespace ui{
...
void GroupBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_33100ef250bd0142_308_new)
...
void GroupBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_33100ef250bd0142_310_validateData)
HXDLIN( 310)		 ::haxe::ui::components::_Button::ButtonGroups _hx_tmp = ::haxe::ui::components::_Button::ButtonGroups_obj::get_instance();
HXDLIN( 310)		_hx_tmp->add(::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value),( ( ::haxe::ui::components::Button)(this->_component) ));
            	}
