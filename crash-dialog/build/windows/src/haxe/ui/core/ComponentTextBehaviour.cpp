...
HX_DEFINE_STACK_FRAME(_hx_pos_6471ceeb46000777_182_new,"haxe.ui.core.ComponentTextBehaviour","new",0xeb4d7142,"haxe.ui.core.ComponentTextBehaviour.new","haxe/ui/core/ComponentContainer.hx",182,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_6471ceeb46000777_183_set,"haxe.ui.core.ComponentTextBehaviour","set",0xeb513c84,"haxe.ui.core.ComponentTextBehaviour.set","haxe/ui/core/ComponentContainer.hx",183,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentTextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_6471ceeb46000777_182_new)
...
void ComponentTextBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_6471ceeb46000777_183_set)
HXLINE( 184)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE( 185)			return;
            		}
HXLINE( 188)		this->_value = value;
HXLINE( 190)		this->super::set(value);
            	}
