...
HX_DEFINE_STACK_FRAME(_hx_pos_a874a404e2c0a6ca_197_new,"haxe.ui.core.ComponentDisabledBehaviour","new",0x494b2713,"haxe.ui.core.ComponentDisabledBehaviour.new","haxe/ui/core/ComponentContainer.hx",197,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_a874a404e2c0a6ca_202_set,"haxe.ui.core.ComponentDisabledBehaviour","set",0x494ef255,"haxe.ui.core.ComponentDisabledBehaviour.set","haxe/ui/core/ComponentContainer.hx",202,0x0bbfc49c)
HX_LOCAL_STACK_FRAME(_hx_pos_a874a404e2c0a6ca_213_get,"haxe.ui.core.ComponentDisabledBehaviour","get",0x4945d749,"haxe.ui.core.ComponentDisabledBehaviour.get","haxe/ui/core/ComponentContainer.hx",213,0x0bbfc49c)
namespace haxe{
namespace ui{
namespace core{

void ComponentDisabledBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_a874a404e2c0a6ca_197_new)
HXLINE( 198)		super::__construct(component);
HXLINE( 199)		this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool(false);
            	}
...
void ComponentDisabledBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_a874a404e2c0a6ca_202_set)
HXLINE( 203)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(value,this->_value)) {
HXLINE( 204)			return;
            		}
HXLINE( 206)		this->_value = value;
HXLINE( 207)		bool _hx_tmp;
HXDLIN( 207)		if (::hx::IsNotNull( value )) {
HXLINE( 207)			_hx_tmp = (::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(value) == false);
            		}
            		else {
HXLINE( 207)			_hx_tmp = false;
            		}
HXDLIN( 207)		if (_hx_tmp) {
HXLINE( 208)			 ::haxe::ui::core::Component _hx_tmp = this->_component;
HXDLIN( 208)			_hx_tmp->disableInteractivity(::haxe::ui::util::_Variant::Variant_Impl__obj::toBool(value),true,true,null());
            		}
            	}


 ::haxe::ui::util::VariantType ComponentDisabledBehaviour_obj::get(){
            	HX_STACKFRAME(&_hx_pos_a874a404e2c0a6ca_213_get)
HXDLIN( 213)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromBool((this->_component->classes->indexOf(HX_(":disabled",b6,0b,b6,46),null()) != -1));
            	}
