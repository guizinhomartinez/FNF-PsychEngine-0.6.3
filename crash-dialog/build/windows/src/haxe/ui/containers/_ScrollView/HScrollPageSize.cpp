...
HX_DEFINE_STACK_FRAME(_hx_pos_b4b8756cce4b494c_438_new,"haxe.ui.containers._ScrollView.HScrollPageSize","new",0x1788fc50,"haxe.ui.containers._ScrollView.HScrollPageSize.new","haxe/ui/containers/ScrollView.hx",438,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_b4b8756cce4b494c_444_validateData,"haxe.ui.containers._ScrollView.HScrollPageSize","validateData",0x38812bf0,"haxe.ui.containers._ScrollView.HScrollPageSize.validateData","haxe/ui/containers/ScrollView.hx",444,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollPageSize_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_b4b8756cce4b494c_438_new)
HXLINE( 439)		super::__construct(scrollview);
HXLINE( 440)		this->_scrollview = scrollview;
            	}
...
void HScrollPageSize_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_b4b8756cce4b494c_444_validateData)
HXDLIN( 444)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 445)			 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 446)			if (::hx::IsNull( hscroll )) {
HXLINE( 447)				hscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            			}
HXLINE( 449)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 450)				hscroll->set_pageSize(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
