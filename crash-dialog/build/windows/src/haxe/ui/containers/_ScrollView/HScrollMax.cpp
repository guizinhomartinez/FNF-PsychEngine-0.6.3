...
HX_DEFINE_STACK_FRAME(_hx_pos_d0c3bbccbc13d3d6_364_new,"haxe.ui.containers._ScrollView.HScrollMax","new",0x0bbcc3a8,"haxe.ui.containers._ScrollView.HScrollMax.new","haxe/ui/containers/ScrollView.hx",364,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_d0c3bbccbc13d3d6_369_get,"haxe.ui.containers._ScrollView.HScrollMax","get",0x0bb773de,"haxe.ui.containers._ScrollView.HScrollMax.get","haxe/ui/containers/ScrollView.hx",369,0x01b76681)
HX_LOCAL_STACK_FRAME(_hx_pos_d0c3bbccbc13d3d6_378_validateData,"haxe.ui.containers._ScrollView.HScrollMax","validateData",0xa2b5b998,"haxe.ui.containers._ScrollView.HScrollMax.validateData","haxe/ui/containers/ScrollView.hx",378,0x01b76681)
namespace haxe{
namespace ui{
...
void HScrollMax_obj::__construct( ::haxe::ui::containers::ScrollView scrollview){
            	HX_STACKFRAME(&_hx_pos_d0c3bbccbc13d3d6_364_new)
HXLINE( 365)		super::__construct(scrollview);
HXLINE( 366)		this->_scrollview = scrollview;
            	}
...
bool HScrollMax_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType HScrollMax_obj::get(){
            	HX_STACKFRAME(&_hx_pos_d0c3bbccbc13d3d6_369_get)
HXLINE( 370)		 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 371)		if (::hx::IsNull( hscroll )) {
HXLINE( 372)			return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0);
            		}
HXLINE( 374)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromFloat(hscroll->get_max());
            	}


void HScrollMax_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_d0c3bbccbc13d3d6_378_validateData)
HXDLIN( 378)		if ((this->_scrollview->get_virtual() == true)) {
HXLINE( 379)			 ::haxe::ui::components::HorizontalScroll hscroll = this->_scrollview->findComponent(null(),::hx::ClassOf< ::haxe::ui::components::HorizontalScroll >(),false,null()).StaticCast<  ::haxe::ui::components::HorizontalScroll >();
HXLINE( 380)			 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 380)			if (::haxe::ui::util::_Variant::Variant_Impl__obj::gt(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromInt(0))) {
HXLINE( 381)				if (::hx::IsNull( hscroll )) {
HXLINE( 382)					hscroll = ::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->createHScroll();
            				}
            			}
            			else {
HXLINE( 385)				if (::hx::IsNotNull( hscroll )) {
HXLINE( 386)					::hx::TCast<  ::haxe::ui::containers::ScrollViewBuilder >::cast(this->_scrollview->_compositeBuilder)->destroyHScroll();
            				}
            			}
HXLINE( 389)			if (::hx::IsNotNull( hscroll )) {
HXLINE( 390)				hscroll->set_max(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
