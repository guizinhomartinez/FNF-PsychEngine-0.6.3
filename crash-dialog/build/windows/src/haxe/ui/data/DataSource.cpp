...
void DataSource_obj::sortCustom( ::Dynamic fn){
            	HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_157_sortCustom)
            	}


HX_DEFINE_DYNAMIC_FUNC1(DataSource_obj,sortCustom,(void))

void DataSource_obj::sort(::String field,::String direction){
            		HX_BEGIN_LOCAL_FUNC_S3(::hx::LocalFunc,_hx_Closure_0,::String,field1,::String,direction1, ::Dynamic,_g) HXARGC(2)
            		int _hx_run( ::Dynamic o1, ::Dynamic o2){
            			HX_STACKFRAME(&_hx_pos_98c3d89b78a0c130_161_sort)
HXDLIN( 161)			return ( (int)(_g(o1,o2,field1,direction1)) );
            		}
...
HXDLIN( 161)		::String direction1 = direction;
HXDLIN( 161)		this->sortCustom( ::Dynamic(new _hx_Closure_0(field1,direction1,_g)));
            	}


HX_DEFINE_DYNAMIC_FUNC2(DataSource_obj,sort,(void))

int DataSource_obj::sortByFn( ::Dynamic o1, ::Dynamic o2,::String field,::String direction){
