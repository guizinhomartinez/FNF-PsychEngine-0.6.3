...
HX_DEFINE_STACK_FRAME(_hx_pos_28943a1499ce47e8_13_new,"haxe.ui.styles.animation.util.ActuatorOptions","new",0x7f42982f,"haxe.ui.styles.animation.util.ActuatorOptions.new","haxe/ui/styles/animation/util/Actuator.hx",13,0xdc64e2fe)
namespace haxe{
namespace ui{
namespace styles{
namespace animation{
...
void ActuatorOptions_obj::__construct( ::Dynamic delay, ::haxe::ui::styles::EasingFunction easingFunction, ::Dynamic onComplete, ::Dynamic onUpdate){
            	HX_STACKFRAME(&_hx_pos_28943a1499ce47e8_13_new)
HXDLIN(  13)		this->delay = delay;
HXDLIN(  13)		this->easingFunction = easingFunction;
HXDLIN(  13)		this->onComplete = onComplete;
HXDLIN(  13)		this->onUpdate = onUpdate;
            	}
