...
HX_DEFINE_DYNAMIC_FUNC1(Style_obj,set_padding,return )
 ...
 ::haxe::ui::styles::StyleBorderType Style_obj::get_borderType(){
            	HX_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_150_get_borderType)
HXLINE( 151)		 ::haxe::ui::styles::StyleBorderType t = ::haxe::ui::styles::StyleBorderType_obj::Compound_dyn();
HXLINE( 152)		bool _hx_tmp;
HXDLIN( 152)		bool _hx_tmp1;
HXDLIN( 152)		bool _hx_tmp2;
HXDLIN( 152)		bool _hx_tmp3;
HXDLIN( 152)		if (::hx::IsNotNull( this->borderLeftSize )) {
HXLINE( 152)			_hx_tmp3 = ::hx::IsGreater( this->borderLeftSize,0 );
            		}
            		else {
HXLINE( 152)			_hx_tmp3 = false;
            		}
HXDLIN( 152)		if (_hx_tmp3) {
HXLINE( 152)			_hx_tmp2 = ::hx::IsEq( this->borderLeftSize,this->borderRightSize );
            		}
            		else {
HXLINE( 152)			_hx_tmp2 = false;
            		}
HXDLIN( 152)		if (_hx_tmp2) {
HXLINE( 152)			_hx_tmp1 = ::hx::IsEq( this->borderLeftSize,this->borderBottomSize );
            		}
            		else {
HXLINE( 152)			_hx_tmp1 = false;
            		}
HXDLIN( 152)		if (_hx_tmp1) {
HXLINE( 152)			_hx_tmp = ::hx::IsEq( this->borderLeftSize,this->borderTopSize );
            		}
            		else {
HXLINE( 152)			_hx_tmp = false;
            		}
HXDLIN( 152)		if (_hx_tmp) {
HXLINE( 153)			t = ::haxe::ui::styles::StyleBorderType_obj::Full_dyn();
            		}
            		else {
...
HXDLIN( 154)			if (::hx::IsNotNull( this->borderLeftSize )) {
HXLINE( 154)				_hx_tmp3 = ::hx::IsLessEq( this->borderLeftSize,0 );
            			}
            			else {
HXLINE( 154)				_hx_tmp3 = true;
            			}
HXDLIN( 154)			if (_hx_tmp3) {
HXLINE( 154)				if (::hx::IsNotNull( this->borderRightSize )) {
HXLINE( 154)					_hx_tmp2 = ::hx::IsLessEq( this->borderRightSize,0 );
            				}
            				else {
...
HXLINE( 154)				if (::hx::IsNotNull( this->borderBottomSize )) {
HXLINE( 154)					_hx_tmp1 = ::hx::IsLessEq( this->borderRightSize,0 );
            				}
            				else {
...
HXLINE( 154)				if (::hx::IsNotNull( this->borderTopSize )) {
HXLINE( 154)					_hx_tmp = ::hx::IsLessEq( this->borderTopSize,0 );
            				}
            				else {
...
HXLINE( 155)				t = ::haxe::ui::styles::StyleBorderType_obj::None_dyn();
            			}
            		}
HXLINE( 157)		return t;
            	}
...
bool Style_obj::get_hasBorder(){
            	HX_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_162_get_hasBorder)
HXDLIN( 162)		return ::hx::IsPointerNotEq( this->get_borderType(),::haxe::ui::styles::StyleBorderType_obj::None_dyn() );
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Style_obj,get_hasBorder,return )
 ...
 ::Dynamic Style_obj::get_fullBorderSize(){
            	HX_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_166_get_fullBorderSize)
HXLINE( 167)		if (::hx::IsPointerEq( this->get_borderType(),::haxe::ui::styles::StyleBorderType_obj::Full_dyn() )) {
HXLINE( 168)			return this->borderLeftSize;
            		}
HXLINE( 170)		return 0;
            	}
...
void Style_obj::mergeDirectives( ::haxe::ds::StringMap map){
            	HX_GC_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_174_mergeDirectives)
HXDLIN( 174)		 ::Dynamic key = map->keys();
HXDLIN( 174)		while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 174)			::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 175)			 ::haxe::ui::styles::elements::Directive v = ( ( ::haxe::ui::styles::elements::Directive)(map->get(key1)) );
HXLINE( 177)			::String _hx_switch_0 = key1;
            			if (  (_hx_switch_0==HX_("animation-delay",3a,1e,9e,af)) ){
HXLINE( 435)				if (::hx::IsNull( this->animationOptions )) {
HXLINE( 435)					this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            				}
HXLINE( 436)				this->animationOptions->delay = ::haxe::ui::styles::ValueTools_obj::time(v->value);
HXLINE( 434)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("animation-direction",76,d0,26,5b)) ){
HXLINE( 446)				if (::hx::IsNull( this->animationOptions )) {
HXLINE( 446)					this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            				}
HXLINE( 447)				this->animationOptions->direction = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXLINE( 445)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("animation-duration",fd,94,5c,5e)) ){
HXLINE( 429)				if (::hx::IsNull( this->animationOptions )) {
HXLINE( 429)					this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            				}
HXLINE( 430)				this->animationOptions->duration = ::haxe::ui::styles::ValueTools_obj::time(v->value);
HXLINE( 428)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("animation-fill-mode",e4,12,c9,b7)) ){
HXLINE( 449)				if (::hx::IsNull( this->animationOptions )) {
HXLINE( 449)					this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            				}
HXLINE( 450)				this->animationOptions->fillMode = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXLINE( 448)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("animation-iteration-count",56,1d,0c,30)) ){
HXLINE( 438)				if (::hx::IsNull( this->animationOptions )) {
HXLINE( 438)					this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            				}
HXLINE( 439)				 ::haxe::ui::styles::Value _g = v->value;
HXDLIN( 439)				 ::Dynamic _hx_tmp;
HXDLIN( 439)				if ((_g->_hx_getIndex() == 6)) {
HXLINE( 440)					::String val = _g->_hx_getString(0);
HXLINE( 441)					if ((val == HX_("infinite",d4,16,69,da))) {
HXLINE( 439)						_hx_tmp = -1;
            					}
            					else {
HXLINE( 439)						_hx_tmp = 0;
            					}
            				}
            				else {
HXLINE( 439)					_hx_tmp = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
            				}
HXDLIN( 439)				this->animationOptions->iterationCount = _hx_tmp;
HXLINE( 437)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("animation-name",74,af,fd,ae)) ){
HXLINE( 427)				this->animationName = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 427)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("animation-timing-function",f2,dd,68,8f)) ){
HXLINE( 432)				if (::hx::IsNull( this->animationOptions )) {
HXLINE( 432)					this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            				}
HXLINE( 433)				this->animationOptions->easingFunction = ::haxe::ui::styles::ValueTools_obj::calcEasing(v->value);
HXLINE( 431)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("backdrop-filter",8f,d4,b7,89)) ){
HXLINE( 410)				 ::haxe::ui::styles::Value _g = v->value;
HXDLIN( 410)				switch((int)(_g->_hx_getIndex())){
            					case (int)5: {
HXLINE( 411)						::String f = _g->_hx_getString(0);
HXDLIN( 411)						::Array< ::Dynamic> vl = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 411)						{
HXLINE( 412)							::cpp::VirtualArray arr = ::haxe::ui::styles::ValueTools_obj::array(vl);
HXLINE( 413)							arr->insert(0,f);
HXLINE( 414)							this->backdropFilter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(arr));
            						}
            					}
            					break;
            					case (int)6: {
HXLINE( 415)						::String f = _g->_hx_getString(0);
HXLINE( 416)						this->backdropFilter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(::cpp::VirtualArray_obj::__new(1)->init(0,f)));
            					}
            					break;
            					case (int)9: {
HXLINE( 418)						this->backdropFilter = null();
            					}
            					break;
            					default:{
            					}
...
HXLINE( 238)				 ::haxe::ui::styles::Value _g = v->value;
HXLINE( 239)				{
HXLINE( 240)					this->backgroundColor = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXLINE( 241)					if (map->exists(HX_("background-color-end",52,18,72,2e))) {
HXLINE( 242)						this->backgroundColorEnd = ::haxe::ui::styles::ValueTools_obj::_hx_int(( ( ::haxe::ui::styles::elements::Directive)(map->get(HX_("background-color-end",52,18,72,2e))) )->value);
            					}
            					else {
HXLINE( 244)						this->backgroundColorEnd = null();
            					}
            				}
HXLINE( 238)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-color-end",52,18,72,2e)) ){
HXLINE( 248)				this->backgroundColorEnd = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXDLIN( 248)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-gradient-style",93,4c,5d,f2)) ){
HXLINE( 250)				this->backgroundGradientStyle = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 250)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image",7c,96,7a,51)) ){
HXLINE( 255)				this->backgroundImage = ::haxe::ui::styles::ValueTools_obj::variant(v->value);
HXDLIN( 255)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-clip-bottom",77,77,29,f7)) ){
HXLINE( 271)				this->backgroundImageClipBottom = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 271)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-clip-left",93,1d,47,f5)) ){
HXLINE( 267)				this->backgroundImageClipLeft = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 267)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-clip-right",d0,d0,ff,1f)) ){
HXLINE( 269)				this->backgroundImageClipRight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 269)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-clip-top",89,46,05,ca)) ){
HXLINE( 265)				this->backgroundImageClipTop = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 265)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-repeat",4c,e8,d5,ca)) ){
HXLINE( 257)				this->backgroundImageRepeat = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 257)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-slice-bottom",77,2c,4a,86)) ){
HXLINE( 280)				this->backgroundImageSliceBottom = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 280)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-slice-left",93,92,60,b3)) ){
HXLINE( 276)				this->backgroundImageSliceLeft = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 276)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-slice-right",d0,bb,2c,b8)) ){
HXLINE( 278)				this->backgroundImageSliceRight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 278)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-image-slice-top",89,71,91,06)) ){
HXLINE( 274)				this->backgroundImageSliceTop = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 274)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-opacity",2c,9f,1b,c0)) ){
HXLINE( 252)				this->backgroundOpacity = ::haxe::ui::styles::ValueTools_obj::_hx_float(v->value);
HXDLIN( 252)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-position-x",d3,15,69,2f)) ){
HXLINE( 260)				this->backgroundPositionX = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 260)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("background-position-y",d4,15,69,2f)) ){
HXLINE( 262)				this->backgroundPositionY = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 262)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-bottom-color",82,36,ce,4f)) ){
HXLINE( 291)				this->borderBottomColor = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXDLIN( 291)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-bottom-left-radius",77,ad,2b,70)) ){
HXLINE( 325)				this->borderRadiusBottomLeft = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 325)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-bottom-right-radius",a4,c4,36,d7)) ){
HXLINE( 327)				this->borderRadiusBottomRight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
...
HXLINE( 313)					this->borderBottomSize = 0;
            				}
            				else {
HXLINE( 315)					this->borderBottomSize = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
            				}
HXLINE( 312)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-color",02,74,10,71)) ){
HXLINE( 283)				this->borderColor = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXDLIN( 283)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-left-color",5e,12,2b,99)) ){
HXLINE( 287)				this->borderLeftColor = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXDLIN( 287)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-left-size",26,78,a1,a1)) ||  (_hx_switch_0==HX_("border-left-width",01,57,31,19)) ){
HXLINE( 300)				if (::hx::IsPointerEq( v->value,::haxe::ui::styles::Value_obj::VNone_dyn() )) {
HXLINE( 301)					this->borderLeftSize = 0;
            				}
            				else {
HXLINE( 303)					this->borderLeftSize = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
            				}
HXLINE( 300)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-opacity",2a,86,16,29)) ){
HXLINE( 330)				this->borderOpacity = ::haxe::ui::styles::ValueTools_obj::_hx_float(v->value);
HXDLIN( 330)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-radius",d3,18,c5,67)) ){
HXLINE( 319)				this->borderRadius = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 319)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-right-color",d1,4a,d2,a1)) ){
HXLINE( 289)				this->borderRightColor = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXDLIN( 289)				goto _hx_goto_6;
            			}
...
HXLINE( 307)					this->borderRightSize = 0;
            				}
            				else {
HXLINE( 309)					this->borderRightSize = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
            				}
HXLINE( 306)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-style",d0,a7,d1,aa)) ){
HXLINE( 332)				this->borderStyle = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 332)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-top-color",8a,f0,a5,c6)) ){
HXLINE( 285)				this->borderTopColor = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXDLIN( 285)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-top-left-radius",7f,9d,36,07)) ){
HXLINE( 321)				this->borderRadiusTopLeft = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 321)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-top-right-radius",9c,db,bd,69)) ){
HXLINE( 323)				this->borderRadiusTopRight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 323)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("border-top-size",7a,83,50,ad)) ||  (_hx_switch_0==HX_("border-top-width",2d,35,ac,46)) ){
HXLINE( 294)				if (::hx::IsPointerEq( v->value,::haxe::ui::styles::Value_obj::VNone_dyn() )) {
HXLINE( 295)					this->borderTopSize = 0;
            				}
            				else {
HXLINE( 297)					this->borderTopSize = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
            				}
HXLINE( 294)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("clip",d0,6e,c2,41)) ){
HXLINE( 386)				this->clip = ::haxe::ui::styles::ValueTools_obj::_hx_bool(v->value);
HXDLIN( 386)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("color",63,71,5c,4a)) ){
HXLINE( 235)				this->color = ::haxe::ui::styles::ValueTools_obj::_hx_int(v->value);
HXDLIN( 235)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("content-height",bb,63,11,ea)) ){
HXLINE( 469)				this->contentHeight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 470)				this->contentHeightPercent = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 468)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("content-type",8e,f1,71,89)) ){
HXLINE( 461)				this->contentType = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 461)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("content-width",b2,b0,d8,69)) ){
HXLINE( 466)				this->contentWidth = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 467)				this->contentWidthPercent = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 465)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("cursor",d6,8e,e8,3e)) ){
HXLINE( 379)				this->cursor = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 379)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("direction",3f,62,40,10)) ){
HXLINE( 463)				this->direction = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 463)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("display",42,2a,4a,bb)) ){
HXLINE( 383)				this->hidden = ::haxe::ui::styles::ValueTools_obj::none(v->value);
HXDLIN( 383)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("filter",b8,1f,35,85)) ){
HXLINE( 393)				 ::haxe::ui::styles::Value _g = v->value;
HXDLIN( 393)				switch((int)(_g->_hx_getIndex())){
            					case (int)5: {
HXLINE( 394)						::String f = _g->_hx_getString(0);
HXDLIN( 394)						::Array< ::Dynamic> vl = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 394)						{
HXLINE( 395)							::cpp::VirtualArray arr = ::haxe::ui::styles::ValueTools_obj::array(vl);
HXLINE( 396)							arr->insert(0,f);
HXLINE( 397)							this->filter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(arr));
            						}
            					}
            					break;
            					case (int)6: {
HXLINE( 398)						::String f = _g->_hx_getString(0);
HXLINE( 399)						this->filter = ::Array_obj< ::Dynamic>::__new(1)->init(0,::haxe::ui::filters::FilterParser_obj::parseFilter(::cpp::VirtualArray_obj::__new(1)->init(0,f)));
            					}
            					break;
            					case (int)9: {
HXLINE( 401)						this->filter = null();
            					}
            					break;
            					default:{
            					}
            				}
HXLINE( 393)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("font-bold",03,d0,d1,42)) ){
HXLINE( 363)				this->fontBold = ::haxe::ui::styles::ValueTools_obj::_hx_bool(v->value);
HXDLIN( 363)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("font-family",a2,c9,66,81)) ||  (_hx_switch_0==HX_("font-name",c9,c0,b5,4a)) ){
HXLINE( 355)				this->fontName = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 355)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("font-italic",ee,98,29,9d)) ){
HXLINE( 367)				this->fontItalic = ::haxe::ui::styles::ValueTools_obj::_hx_bool(v->value);
HXDLIN( 367)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("font-size",3f,ef,09,4e)) ){
HXLINE( 357)				this->fontSize = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 357)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("font-style",f3,04,ec,01)) ){
HXLINE( 369)				if (::hx::IsNotNull( ::haxe::ui::styles::ValueTools_obj::string(v->value) )) {
HXLINE( 370)					this->fontItalic = (::haxe::ui::styles::ValueTools_obj::string(v->value).toLowerCase() == HX_("italic",f0,2e,64,06));
            				}
HXLINE( 369)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("font-underline",ce,7d,77,c9)) ){
HXLINE( 365)				this->fontUnderline = ::haxe::ui::styles::ValueTools_obj::_hx_bool(v->value);
HXDLIN( 365)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("font-weight",76,db,6b,98)) ){
HXLINE( 359)				if (::hx::IsNotNull( ::haxe::ui::styles::ValueTools_obj::string(v->value) )) {
HXLINE( 360)					this->fontBold = (::haxe::ui::styles::ValueTools_obj::string(v->value).toLowerCase() == HX_("bold",85,81,1b,41));
            				}
HXLINE( 359)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("height",e7,07,4c,02)) ){
HXLINE( 198)				this->autoHeight = ::haxe::ui::styles::ValueTools_obj::constant(v->value,HX_("auto",6f,df,76,40));
HXLINE( 199)				this->height = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 200)				this->percentHeight = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 197)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("hidden",6a,ff,95,4c)) ){
HXLINE( 381)				this->hidden = ::haxe::ui::styles::ValueTools_obj::_hx_bool(v->value);
HXDLIN( 381)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("horizontal-align",5c,53,a7,93)) ){
HXLINE( 345)				this->horizontalAlign = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 345)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("horizontal-spacing",da,c3,ba,32)) ){
HXLINE( 230)				this->horizontalSpacing = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 230)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("icon",79,e7,b2,45)) ){
HXLINE( 335)				if ((v->value->_hx_getIndex() == 9)) {
HXLINE( 337)					this->icon = null();
            				}
            				else {
HXLINE( 339)					this->icon = ::haxe::ui::styles::ValueTools_obj::variant(v->value);
            				}
HXLINE( 335)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("icon-position",3d,f7,d4,68)) ){
HXLINE( 342)				this->iconPosition = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 342)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("image-rendering",9a,ec,40,53)) ){
HXLINE( 474)				if ((v->value->_hx_getIndex() == 9)) {
HXLINE( 476)					this->imageRendering = null();
            				}
            				else {
HXLINE( 478)					this->imageRendering = ::haxe::ui::styles::ValueTools_obj::string(v->value);
            				}
HXLINE( 474)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("initial-height",d0,af,f7,6c)) ){
HXLINE( 202)				this->initialHeight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 203)				this->initialPercentHeight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 201)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("initial-width",3d,3e,ce,5d)) ){
HXLINE( 188)				this->initialWidth = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 189)				this->initialPercentWidth = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 187)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("layout",aa,ae,b8,58)) ){
HXLINE( 481)				if ((v->value->_hx_getIndex() == 9)) {
HXLINE( 483)					this->layout = null();
            				}
            				else {
HXLINE( 485)					this->layout = ::haxe::ui::styles::ValueTools_obj::string(v->value);
            				}
HXLINE( 481)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("left",07,08,b0,47)) ){
HXLINE( 179)				this->left = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 179)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("margin-bottom",6a,d8,ef,2a)) ){
HXLINE( 227)				this->marginBottom = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 227)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("margin-left",c6,4b,ff,e7)) ){
HXLINE( 223)				this->marginLeft = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 223)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("margin-right",3d,0f,70,8e)) ){
HXLINE( 225)				this->marginRight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 225)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("margin-top",b6,1f,6b,70)) ){
HXLINE( 221)				this->marginTop = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 221)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("max-height",b0,39,65,ee)) ){
HXLINE( 208)				this->maxHeight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 209)				this->maxPercentHeight = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 207)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("max-width",5d,90,68,c3)) ){
HXLINE( 194)				this->maxWidth = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 195)				this->maxPercentWidth = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 193)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("min-height",82,0c,f8,49)) ){
HXLINE( 205)				this->minHeight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 206)				this->minPercentHeight = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 204)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("min-width",cb,7d,25,ed)) ){
HXLINE( 191)				this->minWidth = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 192)				this->minPercentWidth = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 190)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("mode",63,d3,60,48)) ){
HXLINE( 452)				this->mode = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 452)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("native",97,c9,1c,22)) ){
HXLINE( 388)				this->native = ::haxe::ui::styles::ValueTools_obj::_hx_bool(v->value);
HXDLIN( 388)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("opacity",cb,5d,65,eb)) ){
HXLINE( 352)				this->opacity = ::haxe::ui::styles::ValueTools_obj::_hx_float(v->value);
HXDLIN( 352)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("padding-bottom",27,b9,bd,d9)) ){
HXLINE( 218)				this->paddingBottom = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 218)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("padding-left",43,93,ce,ce)) ){
HXLINE( 214)				this->paddingLeft = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 214)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("padding-right",20,55,ff,9c)) ){
HXLINE( 216)				this->paddingRight = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 216)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("padding-top",d9,16,74,71)) ){
HXLINE( 212)				this->paddingTop = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 212)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("pointer-events",e9,af,84,7a)) ){
HXLINE( 454)				if ((v->value->_hx_getIndex() == 9)) {
HXLINE( 456)					this->pointerEvents = HX_("none",b8,12,0a,49);
            				}
            				else {
HXLINE( 458)					this->pointerEvents = ::haxe::ui::styles::ValueTools_obj::string(v->value);
            				}
HXLINE( 454)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("resource",ce,5c,a0,12)) ){
HXLINE( 425)				this->resource = ::haxe::ui::styles::ValueTools_obj::variant(v->value);
HXDLIN( 425)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("text-align",e5,9f,fc,21)) ){
HXLINE( 349)				this->textAlign = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 349)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("text-decoration",10,b8,a7,ac)) ){
HXLINE( 373)				if (::hx::IsNotNull( ::haxe::ui::styles::ValueTools_obj::string(v->value) )) {
HXLINE( 374)					this->fontUnderline = (::haxe::ui::styles::ValueTools_obj::string(v->value).toLowerCase() == HX_("underline",0c,15,d1,87));
HXLINE( 375)					this->fontStrikeThrough = (::haxe::ui::styles::ValueTools_obj::string(v->value).toLowerCase() == HX_("line-through",ac,83,55,d9));
            				}
HXLINE( 373)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("top",95,66,58,00)) ){
HXLINE( 181)				this->top = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 181)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("vertical-align",6e,0c,90,b5)) ){
HXLINE( 347)				this->verticalAlign = ::haxe::ui::styles::ValueTools_obj::string(v->value);
HXDLIN( 347)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("vertical-spacing",6c,65,11,2b)) ){
HXLINE( 232)				this->verticalSpacing = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXDLIN( 232)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("width",06,b6,62,ca)) ){
HXLINE( 184)				this->autoWidth = ::haxe::ui::styles::ValueTools_obj::constant(v->value,HX_("auto",6f,df,76,40));
HXLINE( 185)				this->width = ::haxe::ui::styles::ValueTools_obj::calcDimension(v->value);
HXLINE( 186)				this->percentWidth = ::haxe::ui::styles::ValueTools_obj::percent(v->value);
HXLINE( 183)				goto _hx_goto_6;
            			}
            			if (  (_hx_switch_0==HX_("word-wrap",6d,96,5d,93)) ){
HXLINE( 472)				this->wordWrap = ::haxe::ui::styles::ValueTools_obj::_hx_bool(v->value);
HXDLIN( 472)				goto _hx_goto_6;
            			}
            			_hx_goto_6:;
            		}
            	}
...
void Style_obj::apply( ::haxe::ui::styles::Style s){
            	HX_GC_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_491_apply)
HXLINE( 492)		if (::hx::IsNotNull( s->cursor )) {
HXLINE( 492)			this->cursor = s->cursor;
            		}
HXLINE( 493)		if (::hx::IsNotNull( s->hidden )) {
HXLINE( 493)			this->hidden = s->hidden;
            		}
HXLINE( 495)		if (::hx::IsNotNull( s->left )) {
HXLINE( 495)			this->left = s->left;
            		}
HXLINE( 496)		if (::hx::IsNotNull( s->top )) {
HXLINE( 496)			this->top = s->top;
            		}
HXLINE( 498)		if (::hx::IsNotNull( s->autoWidth )) {
HXLINE( 498)			this->autoWidth = s->autoWidth;
            		}
HXLINE( 499)		if (::hx::IsNotNull( s->autoHeight )) {
HXLINE( 499)			this->autoHeight = s->autoHeight;
            		}
HXLINE( 500)		if (::hx::IsNotNull( s->verticalSpacing )) {
HXLINE( 500)			this->verticalSpacing = s->verticalSpacing;
            		}
HXLINE( 501)		if (::hx::IsNotNull( s->horizontalSpacing )) {
HXLINE( 501)			this->horizontalSpacing = s->horizontalSpacing;
            		}
HXLINE( 503)		if (::hx::IsNotNull( s->width )) {
HXLINE( 504)			this->width = s->width;
HXLINE( 505)			this->autoWidth = false;
            		}
HXLINE( 507)		if (::hx::IsNotNull( s->initialWidth )) {
HXLINE( 507)			this->initialWidth = s->initialWidth;
            		}
HXLINE( 508)		if (::hx::IsNotNull( s->initialPercentWidth )) {
HXLINE( 508)			this->initialPercentWidth = s->initialPercentWidth;
            		}
HXLINE( 509)		if (::hx::IsNotNull( s->minWidth )) {
HXLINE( 509)			this->minWidth = s->minWidth;
            		}
HXLINE( 510)		if (::hx::IsNotNull( s->minPercentWidth )) {
HXLINE( 510)			this->minPercentWidth = s->minPercentWidth;
            		}
HXLINE( 511)		if (::hx::IsNotNull( s->maxWidth )) {
HXLINE( 511)			this->maxWidth = s->maxWidth;
            		}
HXLINE( 512)		if (::hx::IsNotNull( s->maxPercentWidth )) {
HXLINE( 512)			this->maxPercentWidth = s->maxPercentWidth;
            		}
HXLINE( 514)		if (::hx::IsNotNull( s->height )) {
HXLINE( 515)			this->height = s->height;
HXLINE( 516)			this->autoHeight = false;
            		}
HXLINE( 518)		if (::hx::IsNotNull( s->initialHeight )) {
HXLINE( 518)			this->initialHeight = s->initialHeight;
            		}
HXLINE( 519)		if (::hx::IsNotNull( s->initialPercentHeight )) {
HXLINE( 519)			this->initialPercentHeight = s->initialPercentHeight;
            		}
HXLINE( 520)		if (::hx::IsNotNull( s->minHeight )) {
HXLINE( 520)			this->minHeight = s->minHeight;
            		}
HXLINE( 521)		if (::hx::IsNotNull( s->minPercentHeight )) {
HXLINE( 521)			this->minPercentHeight = s->minPercentHeight;
            		}
HXLINE( 522)		if (::hx::IsNotNull( s->maxHeight )) {
HXLINE( 522)			this->maxHeight = s->maxHeight;
            		}
HXLINE( 523)		if (::hx::IsNotNull( s->maxPercentHeight )) {
HXLINE( 523)			this->maxPercentHeight = s->maxPercentHeight;
            		}
HXLINE( 525)		if (::hx::IsNotNull( s->percentWidth )) {
HXLINE( 526)			this->percentWidth = s->percentWidth;
HXLINE( 527)			this->autoWidth = false;
            		}
HXLINE( 529)		if (::hx::IsNotNull( s->percentHeight )) {
HXLINE( 530)			this->percentHeight = s->percentHeight;
HXLINE( 531)			this->autoHeight = false;
            		}
HXLINE( 534)		if (::hx::IsNotNull( s->paddingTop )) {
HXLINE( 534)			this->paddingTop = s->paddingTop;
            		}
HXLINE( 535)		if (::hx::IsNotNull( s->paddingLeft )) {
HXLINE( 535)			this->paddingLeft = s->paddingLeft;
            		}
HXLINE( 536)		if (::hx::IsNotNull( s->paddingRight )) {
HXLINE( 536)			this->paddingRight = s->paddingRight;
            		}
HXLINE( 537)		if (::hx::IsNotNull( s->paddingBottom )) {
HXLINE( 537)			this->paddingBottom = s->paddingBottom;
            		}
HXLINE( 539)		if (::hx::IsNotNull( s->marginTop )) {
HXLINE( 539)			this->marginTop = s->marginTop;
            		}
HXLINE( 540)		if (::hx::IsNotNull( s->marginLeft )) {
HXLINE( 540)			this->marginLeft = s->marginLeft;
            		}
HXLINE( 541)		if (::hx::IsNotNull( s->marginRight )) {
HXLINE( 541)			this->marginRight = s->marginRight;
            		}
HXLINE( 542)		if (::hx::IsNotNull( s->marginBottom )) {
HXLINE( 542)			this->marginBottom = s->marginBottom;
            		}
HXLINE( 544)		if (::hx::IsNotNull( s->color )) {
HXLINE( 544)			this->color = s->color;
            		}
HXLINE( 546)		if (::hx::IsNotNull( s->backgroundColor )) {
HXLINE( 547)			this->backgroundColor = s->backgroundColor;
HXLINE( 548)			this->backgroundColorEnd = null();
            		}
HXLINE( 550)		if (::hx::IsNotNull( s->backgroundColorEnd )) {
HXLINE( 550)			this->backgroundColorEnd = s->backgroundColorEnd;
            		}
HXLINE( 551)		if (::hx::IsNotNull( s->backgroundGradientStyle )) {
HXLINE( 551)			this->backgroundGradientStyle = s->backgroundGradientStyle;
            		}
HXLINE( 552)		if (::hx::IsNotNull( s->backgroundOpacity )) {
HXLINE( 552)			this->backgroundOpacity = s->backgroundOpacity;
            		}
HXLINE( 554)		if (::hx::IsNotNull( s->backgroundImage )) {
HXLINE( 554)			this->backgroundImage = s->backgroundImage;
            		}
HXLINE( 555)		if (::hx::IsNotNull( s->backgroundImageRepeat )) {
HXLINE( 555)			this->backgroundImageRepeat = s->backgroundImageRepeat;
            		}
HXLINE( 557)		if (::hx::IsNotNull( s->backgroundImageClipTop )) {
HXLINE( 557)			this->backgroundImageClipTop = s->backgroundImageClipTop;
            		}
HXLINE( 558)		if (::hx::IsNotNull( s->backgroundImageClipLeft )) {
HXLINE( 558)			this->backgroundImageClipLeft = s->backgroundImageClipLeft;
            		}
HXLINE( 559)		if (::hx::IsNotNull( s->backgroundImageClipBottom )) {
HXLINE( 559)			this->backgroundImageClipBottom = s->backgroundImageClipBottom;
            		}
HXLINE( 560)		if (::hx::IsNotNull( s->backgroundImageClipRight )) {
HXLINE( 560)			this->backgroundImageClipRight = s->backgroundImageClipRight;
            		}
HXLINE( 562)		if (::hx::IsNotNull( s->backgroundImageSliceTop )) {
HXLINE( 562)			this->backgroundImageSliceTop = s->backgroundImageSliceTop;
            		}
HXLINE( 563)		if (::hx::IsNotNull( s->backgroundImageSliceLeft )) {
HXLINE( 563)			this->backgroundImageSliceLeft = s->backgroundImageSliceLeft;
            		}
HXLINE( 564)		if (::hx::IsNotNull( s->backgroundImageSliceBottom )) {
HXLINE( 564)			this->backgroundImageSliceBottom = s->backgroundImageSliceBottom;
            		}
HXLINE( 565)		if (::hx::IsNotNull( s->backgroundImageSliceRight )) {
HXLINE( 565)			this->backgroundImageSliceRight = s->backgroundImageSliceRight;
            		}
HXLINE( 567)		if (::hx::IsNotNull( s->borderColor )) {
HXLINE( 567)			this->borderColor = s->borderColor;
            		}
HXLINE( 568)		if (::hx::IsNotNull( s->borderTopColor )) {
HXLINE( 568)			this->borderTopColor = s->borderTopColor;
            		}
HXLINE( 569)		if (::hx::IsNotNull( s->borderLeftColor )) {
HXLINE( 569)			this->borderLeftColor = s->borderLeftColor;
            		}
HXLINE( 570)		if (::hx::IsNotNull( s->borderBottomColor )) {
HXLINE( 570)			this->borderBottomColor = s->borderBottomColor;
            		}
HXLINE( 571)		if (::hx::IsNotNull( s->borderRightColor )) {
HXLINE( 571)			this->borderRightColor = s->borderRightColor;
            		}
HXLINE( 573)		if (::hx::IsNotNull( s->borderSize )) {
HXLINE( 573)			this->borderSize = s->borderSize;
            		}
HXLINE( 574)		if (::hx::IsNotNull( s->borderTopSize )) {
HXLINE( 574)			this->borderTopSize = s->borderTopSize;
            		}
HXLINE( 575)		if (::hx::IsNotNull( s->borderLeftSize )) {
HXLINE( 575)			this->borderLeftSize = s->borderLeftSize;
            		}
HXLINE( 576)		if (::hx::IsNotNull( s->borderBottomSize )) {
HXLINE( 576)			this->borderBottomSize = s->borderBottomSize;
            		}
HXLINE( 577)		if (::hx::IsNotNull( s->borderRightSize )) {
HXLINE( 577)			this->borderRightSize = s->borderRightSize;
            		}
HXLINE( 579)		if (::hx::IsNotNull( s->borderRadius )) {
HXLINE( 579)			this->borderRadius = s->borderRadius;
            		}
HXLINE( 580)		if (::hx::IsNotNull( s->borderRadiusTopLeft )) {
HXLINE( 580)			this->borderRadiusTopLeft = s->borderRadiusTopLeft;
            		}
HXLINE( 581)		if (::hx::IsNotNull( s->borderRadiusTopRight )) {
HXLINE( 581)			this->borderRadiusTopRight = s->borderRadiusTopRight;
            		}
HXLINE( 582)		if (::hx::IsNotNull( s->borderRadiusBottomLeft )) {
HXLINE( 582)			this->borderRadiusBottomLeft = s->borderRadiusBottomLeft;
            		}
HXLINE( 583)		if (::hx::IsNotNull( s->borderRadiusBottomRight )) {
HXLINE( 583)			this->borderRadiusBottomRight = s->borderRadiusBottomRight;
            		}
HXLINE( 584)		if (::hx::IsNotNull( s->borderOpacity )) {
HXLINE( 584)			this->borderOpacity = s->borderOpacity;
            		}
HXLINE( 585)		if (::hx::IsNotNull( s->borderStyle )) {
HXLINE( 585)			this->borderStyle = s->borderStyle;
            		}
HXLINE( 587)		if (::hx::IsNotNull( s->filter )) {
HXLINE( 587)			this->filter = s->filter->copy();
            		}
HXLINE( 588)		if (::hx::IsNotNull( s->backdropFilter )) {
HXLINE( 588)			this->backdropFilter = s->backdropFilter->copy();
            		}
HXLINE( 589)		if (::hx::IsNotNull( s->resource )) {
HXLINE( 589)			this->resource = s->resource;
            		}
HXLINE( 591)		if (::hx::IsNotNull( s->icon )) {
HXLINE( 591)			this->icon = s->icon;
            		}
HXLINE( 592)		if (::hx::IsNotNull( s->iconPosition )) {
HXLINE( 592)			this->iconPosition = s->iconPosition;
            		}
HXLINE( 594)		if (::hx::IsNotNull( s->horizontalAlign )) {
HXLINE( 594)			this->horizontalAlign = s->horizontalAlign;
            		}
HXLINE( 595)		if (::hx::IsNotNull( s->verticalAlign )) {
HXLINE( 595)			this->verticalAlign = s->verticalAlign;
            		}
HXLINE( 596)		if (::hx::IsNotNull( s->textAlign )) {
HXLINE( 596)			this->textAlign = s->textAlign;
            		}
HXLINE( 598)		if (::hx::IsNotNull( s->opacity )) {
HXLINE( 598)			this->opacity = s->opacity;
            		}
HXLINE( 600)		if (::hx::IsNotNull( s->clip )) {
HXLINE( 600)			this->clip = s->clip;
            		}
HXLINE( 601)		if (::hx::IsNotNull( s->native )) {
HXLINE( 601)			this->native = s->native;
            		}
HXLINE( 603)		if (::hx::IsNotNull( s->fontName )) {
HXLINE( 603)			this->fontName = s->fontName;
            		}
HXLINE( 604)		if (::hx::IsNotNull( s->fontSize )) {
HXLINE( 604)			this->fontSize = s->fontSize;
            		}
HXLINE( 605)		if (::hx::IsNotNull( s->fontBold )) {
HXLINE( 605)			this->fontBold = s->fontBold;
            		}
HXLINE( 606)		if (::hx::IsNotNull( s->fontUnderline )) {
HXLINE( 606)			this->fontUnderline = s->fontUnderline;
            		}
HXLINE( 607)		if (::hx::IsNotNull( s->fontStrikeThrough )) {
HXLINE( 607)			this->fontStrikeThrough = s->fontStrikeThrough;
            		}
HXLINE( 608)		if (::hx::IsNotNull( s->fontItalic )) {
HXLINE( 608)			this->fontItalic = s->fontItalic;
            		}
HXLINE( 610)		if (::hx::IsNotNull( s->animationName )) {
HXLINE( 610)			this->animationName = s->animationName;
            		}
HXLINE( 611)		if (::hx::IsNotNull( s->animationOptions )) {
HXLINE( 612)			if (::hx::IsNull( this->animationOptions )) {
HXLINE( 612)				this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            			}
HXLINE( 613)			if (::hx::IsNotNull( s->animationOptions->duration )) {
HXLINE( 613)				this->animationOptions->duration = s->animationOptions->duration;
            			}
HXLINE( 614)			if (::hx::IsNotNull( s->animationOptions->delay )) {
HXLINE( 614)				this->animationOptions->delay = s->animationOptions->delay;
            			}
HXLINE( 615)			if (::hx::IsNotNull( s->animationOptions->iterationCount )) {
HXLINE( 615)				this->animationOptions->iterationCount = s->animationOptions->iterationCount;
            			}
HXLINE( 616)			if (::hx::IsNotNull( s->animationOptions->easingFunction )) {
HXLINE( 616)				this->animationOptions->easingFunction = s->animationOptions->easingFunction;
            			}
HXLINE( 617)			if (::hx::IsNotNull( s->animationOptions->direction )) {
HXLINE( 617)				this->animationOptions->direction = s->animationOptions->direction;
            			}
HXLINE( 618)			if (::hx::IsNotNull( s->animationOptions->fillMode )) {
HXLINE( 618)				this->animationOptions->fillMode = s->animationOptions->fillMode;
            			}
            		}
HXLINE( 621)		if (::hx::IsNotNull( s->mode )) {
HXLINE( 621)			this->mode = s->mode;
            		}
HXLINE( 622)		if (::hx::IsNotNull( s->pointerEvents )) {
HXLINE( 622)			this->pointerEvents = s->pointerEvents;
            		}
HXLINE( 623)		if (::hx::IsNotNull( s->contentType )) {
HXLINE( 623)			this->contentType = s->contentType;
            		}
HXLINE( 624)		if (::hx::IsNotNull( s->direction )) {
HXLINE( 624)			this->direction = s->direction;
            		}
HXLINE( 626)		if (::hx::IsNotNull( s->contentWidth )) {
HXLINE( 626)			this->contentWidth = s->contentWidth;
            		}
HXLINE( 627)		if (::hx::IsNotNull( s->contentWidthPercent )) {
HXLINE( 627)			this->contentWidthPercent = s->contentWidthPercent;
            		}
HXLINE( 628)		if (::hx::IsNotNull( s->contentHeight )) {
HXLINE( 628)			this->contentHeight = s->contentHeight;
            		}
HXLINE( 629)		if (::hx::IsNotNull( s->contentHeightPercent )) {
HXLINE( 629)			this->contentHeightPercent = s->contentHeightPercent;
            		}
HXLINE( 631)		if (::hx::IsNotNull( s->wordWrap )) {
HXLINE( 631)			this->wordWrap = s->wordWrap;
            		}
HXLINE( 632)		if (::hx::IsNotNull( s->imageRendering )) {
HXLINE( 632)			this->imageRendering = s->imageRendering;
            		}
HXLINE( 633)		if (::hx::IsNotNull( s->layout )) {
HXLINE( 633)			this->layout = s->layout;
            		}
            	}
...
bool Style_obj::equalTo( ::haxe::ui::styles::Style s){
            	HX_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_636_equalTo)
HXLINE( 637)		if (::hx::IsNotEq( s->backgroundColor,this->backgroundColor )) {
HXLINE( 637)			return false;
            		}
HXLINE( 638)		if (::hx::IsNotEq( s->backgroundColorEnd,this->backgroundColorEnd )) {
HXLINE( 638)			return false;
            		}
HXLINE( 639)		if ((s->backgroundGradientStyle != this->backgroundGradientStyle)) {
HXLINE( 639)			return false;
            		}
HXLINE( 640)		if (::hx::IsNotEq( s->backgroundOpacity,this->backgroundOpacity )) {
HXLINE( 640)			return false;
            		}
HXLINE( 642)		if (::hx::IsNotEq( s->borderColor,this->borderColor )) {
HXLINE( 642)			return false;
            		}
HXLINE( 643)		if (::hx::IsNotEq( s->borderTopColor,this->borderTopColor )) {
HXLINE( 643)			return false;
            		}
HXLINE( 644)		if (::hx::IsNotEq( s->borderLeftColor,this->borderLeftColor )) {
HXLINE( 644)			return false;
            		}
HXLINE( 645)		if (::hx::IsNotEq( s->borderBottomColor,this->borderBottomColor )) {
HXLINE( 645)			return false;
            		}
HXLINE( 646)		if (::hx::IsNotEq( s->borderRightColor,this->borderRightColor )) {
HXLINE( 646)			return false;
            		}
HXLINE( 648)		if (::hx::IsNotEq( s->borderSize,this->borderSize )) {
HXLINE( 648)			return false;
            		}
HXLINE( 649)		if (::hx::IsNotEq( s->borderTopSize,this->borderTopSize )) {
HXLINE( 649)			return false;
            		}
HXLINE( 650)		if (::hx::IsNotEq( s->borderLeftSize,this->borderLeftSize )) {
HXLINE( 650)			return false;
            		}
HXLINE( 651)		if (::hx::IsNotEq( s->borderBottomSize,this->borderBottomSize )) {
HXLINE( 651)			return false;
            		}
HXLINE( 652)		if (::hx::IsNotEq( s->borderRightSize,this->borderRightSize )) {
HXLINE( 652)			return false;
            		}
HXLINE( 654)		if (::hx::IsNotEq( s->borderRadius,this->borderRadius )) {
HXLINE( 654)			return false;
            		}
HXLINE( 655)		if (::hx::IsNotEq( s->borderRadiusTopLeft,this->borderRadiusTopLeft )) {
HXLINE( 655)			return false;
            		}
HXLINE( 656)		if (::hx::IsNotEq( s->borderRadiusTopRight,this->borderRadiusTopRight )) {
HXLINE( 656)			return false;
            		}
HXLINE( 657)		if (::hx::IsNotEq( s->borderRadiusBottomLeft,this->borderRadiusBottomLeft )) {
HXLINE( 657)			return false;
            		}
HXLINE( 658)		if (::hx::IsNotEq( s->borderRadiusBottomRight,this->borderRadiusBottomRight )) {
HXLINE( 658)			return false;
            		}
HXLINE( 659)		if (::hx::IsNotEq( s->borderOpacity,this->borderOpacity )) {
HXLINE( 659)			return false;
            		}
HXLINE( 660)		if ((s->borderStyle != this->borderStyle)) {
HXLINE( 660)			return false;
            		}
HXLINE( 662)		if (::hx::IsNotEq( s->color,this->color )) {
HXLINE( 662)			return false;
            		}
HXLINE( 664)		if ((s->cursor != this->cursor)) {
HXLINE( 664)			return false;
            		}
HXLINE( 665)		if (::hx::IsNotEq( s->hidden,this->hidden )) {
HXLINE( 665)			return false;
            		}
HXLINE( 667)		if (::hx::IsNotEq( s->left,this->left )) {
HXLINE( 667)			return false;
            		}
HXLINE( 668)		if (::hx::IsNotEq( s->top,this->top )) {
HXLINE( 668)			return false;
            		}
HXLINE( 670)		if (::hx::IsNotEq( s->autoWidth,this->autoWidth )) {
HXLINE( 670)			return false;
            		}
HXLINE( 671)		if (::hx::IsNotEq( s->autoHeight,this->autoHeight )) {
HXLINE( 671)			return false;
            		}
HXLINE( 672)		if (::hx::IsNotEq( s->verticalSpacing,this->verticalSpacing )) {
HXLINE( 672)			return false;
            		}
HXLINE( 673)		if (::hx::IsNotEq( s->horizontalSpacing,this->horizontalSpacing )) {
HXLINE( 673)			return false;
            		}
HXLINE( 675)		if (::hx::IsNotEq( s->width,this->width )) {
HXLINE( 675)			return false;
            		}
HXLINE( 676)		if (::hx::IsNotEq( s->initialWidth,this->initialWidth )) {
HXLINE( 676)			return false;
            		}
HXLINE( 677)		if (::hx::IsNotEq( s->initialPercentWidth,this->initialPercentWidth )) {
HXLINE( 677)			return false;
            		}
HXLINE( 678)		if (::hx::IsNotEq( s->minWidth,this->minWidth )) {
HXLINE( 678)			return false;
            		}
HXLINE( 679)		if (::hx::IsNotEq( s->minPercentWidth,this->minPercentWidth )) {
HXLINE( 679)			return false;
            		}
HXLINE( 680)		if (::hx::IsNotEq( s->maxWidth,this->maxWidth )) {
HXLINE( 680)			return false;
            		}
HXLINE( 681)		if (::hx::IsNotEq( s->maxPercentWidth,this->maxPercentWidth )) {
HXLINE( 681)			return false;
            		}
HXLINE( 683)		if (::hx::IsNotEq( s->height,this->height )) {
HXLINE( 683)			return false;
            		}
HXLINE( 684)		if (::hx::IsNotEq( s->initialHeight,this->initialHeight )) {
HXLINE( 684)			return false;
            		}
HXLINE( 685)		if (::hx::IsNotEq( s->initialPercentHeight,this->initialPercentHeight )) {
HXLINE( 685)			return false;
            		}
HXLINE( 686)		if (::hx::IsNotEq( s->minHeight,this->minHeight )) {
HXLINE( 686)			return false;
            		}
HXLINE( 687)		if (::hx::IsNotEq( s->minPercentHeight,this->minPercentHeight )) {
HXLINE( 687)			return false;
            		}
HXLINE( 688)		if (::hx::IsNotEq( s->maxHeight,this->maxHeight )) {
HXLINE( 688)			return false;
            		}
HXLINE( 689)		if (::hx::IsNotEq( s->maxPercentHeight,this->maxPercentHeight )) {
HXLINE( 689)			return false;
            		}
HXLINE( 691)		if (::hx::IsNotEq( s->percentWidth,this->percentWidth )) {
HXLINE( 691)			return false;
            		}
HXLINE( 692)		if (::hx::IsNotEq( s->percentHeight,this->percentHeight )) {
HXLINE( 692)			return false;
            		}
HXLINE( 694)		if (::hx::IsNotEq( s->paddingTop,this->paddingTop )) {
HXLINE( 694)			return false;
            		}
HXLINE( 695)		if (::hx::IsNotEq( s->paddingLeft,this->paddingLeft )) {
HXLINE( 695)			return false;
            		}
HXLINE( 696)		if (::hx::IsNotEq( s->paddingRight,this->paddingRight )) {
HXLINE( 696)			return false;
            		}
HXLINE( 697)		if (::hx::IsNotEq( s->paddingBottom,this->paddingBottom )) {
HXLINE( 697)			return false;
            		}
HXLINE( 699)		if (::hx::IsNotEq( s->marginTop,this->marginTop )) {
HXLINE( 699)			return false;
            		}
HXLINE( 700)		if (::hx::IsNotEq( s->marginLeft,this->marginLeft )) {
HXLINE( 700)			return false;
            		}
HXLINE( 701)		if (::hx::IsNotEq( s->marginRight,this->marginRight )) {
HXLINE( 701)			return false;
            		}
HXLINE( 702)		if (::hx::IsNotEq( s->marginBottom,this->marginBottom )) {
HXLINE( 702)			return false;
            		}
HXLINE( 704)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::neq(s->backgroundImage,this->backgroundImage)) {
HXLINE( 704)			return false;
            		}
HXLINE( 705)		if ((s->backgroundImageRepeat != this->backgroundImageRepeat)) {
HXLINE( 705)			return false;
            		}
HXLINE( 707)		if (::hx::IsNotEq( s->backgroundImageClipTop,this->backgroundImageClipTop )) {
HXLINE( 707)			return false;
            		}
HXLINE( 708)		if (::hx::IsNotEq( s->backgroundImageClipLeft,this->backgroundImageClipLeft )) {
HXLINE( 708)			return false;
            		}
HXLINE( 709)		if (::hx::IsNotEq( s->backgroundImageClipBottom,this->backgroundImageClipBottom )) {
HXLINE( 709)			return false;
            		}
HXLINE( 710)		if (::hx::IsNotEq( s->backgroundImageClipRight,this->backgroundImageClipRight )) {
HXLINE( 710)			return false;
            		}
HXLINE( 712)		if (::hx::IsNotEq( s->backgroundImageSliceTop,this->backgroundImageSliceTop )) {
HXLINE( 712)			return false;
            		}
HXLINE( 713)		if (::hx::IsNotEq( s->backgroundImageSliceLeft,this->backgroundImageSliceLeft )) {
HXLINE( 713)			return false;
            		}
HXLINE( 714)		if (::hx::IsNotEq( s->backgroundImageSliceBottom,this->backgroundImageSliceBottom )) {
HXLINE( 714)			return false;
            		}
HXLINE( 715)		if (::hx::IsNotEq( s->backgroundImageSliceRight,this->backgroundImageSliceRight )) {
HXLINE( 715)			return false;
            		}
HXLINE( 717)		if (::hx::IsPointerNotEq( s->filter,this->filter )) {
HXLINE( 717)			return false;
            		}
HXLINE( 718)		if (::hx::IsPointerNotEq( s->backdropFilter,this->backdropFilter )) {
HXLINE( 718)			return false;
            		}
HXLINE( 719)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::neq(s->resource,this->resource)) {
HXLINE( 719)			return false;
            		}
HXLINE( 721)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::neq(s->icon,this->icon)) {
HXLINE( 721)			return false;
            		}
HXLINE( 722)		if ((s->iconPosition != this->iconPosition)) {
HXLINE( 722)			return false;
            		}
HXLINE( 724)		if ((s->horizontalAlign != this->horizontalAlign)) {
HXLINE( 724)			return false;
            		}
HXLINE( 725)		if ((s->verticalAlign != this->verticalAlign)) {
HXLINE( 725)			return false;
            		}
HXLINE( 726)		if ((s->textAlign != this->textAlign)) {
HXLINE( 726)			return false;
            		}
HXLINE( 728)		if (::hx::IsNotEq( s->opacity,this->opacity )) {
HXLINE( 728)			return false;
            		}
HXLINE( 730)		if (::hx::IsNotEq( s->clip,this->clip )) {
HXLINE( 730)			return false;
            		}
HXLINE( 731)		if (::hx::IsNotEq( s->native,this->native )) {
HXLINE( 731)			return false;
            		}
HXLINE( 733)		if ((s->fontName != this->fontName)) {
HXLINE( 733)			return false;
            		}
HXLINE( 734)		if (::hx::IsNotEq( s->fontSize,this->fontSize )) {
HXLINE( 734)			return false;
            		}
HXLINE( 735)		if (::hx::IsNotEq( s->fontBold,this->fontBold )) {
HXLINE( 735)			return false;
            		}
HXLINE( 736)		if (::hx::IsNotEq( s->fontUnderline,this->fontUnderline )) {
HXLINE( 736)			return false;
            		}
HXLINE( 737)		if (::hx::IsNotEq( s->fontStrikeThrough,this->fontStrikeThrough )) {
HXLINE( 737)			return false;
            		}
HXLINE( 738)		if (::hx::IsNotEq( s->fontItalic,this->fontItalic )) {
HXLINE( 738)			return false;
            		}
HXLINE( 740)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::neq(s->resource,this->resource)) {
HXLINE( 740)			return false;
            		}
HXLINE( 741)		if ((s->animationName != this->animationName)) {
HXLINE( 741)			return false;
            		}
HXLINE( 742)		bool _hx_tmp;
HXDLIN( 742)		if (::hx::IsNotNull( this->animationOptions )) {
HXLINE( 742)			_hx_tmp = (this->animationOptions->compareTo(s->animationOptions) == false);
            		}
            		else {
...
HXLINE( 744)		if ((s->mode != this->mode)) {
HXLINE( 744)			return false;
            		}
HXLINE( 745)		if ((s->pointerEvents != this->pointerEvents)) {
HXLINE( 745)			return false;
            		}
HXLINE( 746)		if ((s->contentType != this->contentType)) {
HXLINE( 746)			return false;
            		}
HXLINE( 747)		if ((s->direction != this->direction)) {
HXLINE( 747)			return false;
            		}
HXLINE( 749)		if (::hx::IsNotEq( s->contentWidth,this->contentWidth )) {
HXLINE( 749)			return false;
            		}
HXLINE( 750)		if (::hx::IsNotEq( s->contentWidthPercent,this->contentWidthPercent )) {
HXLINE( 750)			return false;
            		}
HXLINE( 751)		if (::hx::IsNotEq( s->contentHeight,this->contentHeight )) {
HXLINE( 751)			return false;
            		}
HXLINE( 752)		if (::hx::IsNotEq( s->contentHeightPercent,this->contentHeightPercent )) {
HXLINE( 752)			return false;
            		}
HXLINE( 754)		if (::hx::IsNotEq( s->wordWrap,this->wordWrap )) {
HXLINE( 754)			return false;
            		}
HXLINE( 755)		if ((s->imageRendering != this->imageRendering)) {
HXLINE( 755)			return false;
            		}
HXLINE( 756)		if ((s->layout != this->layout)) {
...
void Style_obj::createAnimationOptions(){
            	HX_GC_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_762_createAnimationOptions)
HXDLIN( 762)		if (::hx::IsNull( this->animationOptions )) {
HXDLIN( 762)			this->animationOptions =  ::haxe::ui::styles::animation::AnimationOptions_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null());
            		}
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(Style_obj,createAnimationOptions,(void))
 ...
 ::haxe::ui::styles::Style Style_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_d9d9665b5ee789a4_765_clone)
HXLINE( 766)		 ::haxe::ui::styles::Style c =  ::haxe::ui::styles::Style_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 767)		c->apply(::hx::ObjectPtr<OBJ_>(this));
HXLINE( 768)		return c;
            	}
