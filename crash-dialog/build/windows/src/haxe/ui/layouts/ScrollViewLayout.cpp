...
HXLINE( 134)				 ::Dynamic _hx_tmp = contents->get_width();
HXDLIN( 134)				if (::hx::IsGreater( _hx_tmp,this->get_component()->get_width() )) {
...
HXLINE( 137)				 ::Dynamic _hx_tmp1 = contents->get_height();
HXDLIN( 137)				if (::hx::IsGreater( _hx_tmp1,this->get_component()->get_height() )) {
