...
HX_LOCAL_STACK_FRAME(_hx_pos_6c73e1b2de27701d_148_repositionChildren,"haxe.ui.layouts.DefaultLayout","repositionChildren",0x12fa9bb5,"haxe.ui.layouts.DefaultLayout.repositionChildren","haxe/ui/layouts/DefaultLayout.hx",148,0x7dc0caab)
namespace haxe{
namespace ui{
namespace layouts{
...
void DefaultLayout_obj::repositionChildren(){
            	HX_STACKFRAME(&_hx_pos_6c73e1b2de27701d_148_repositionChildren)
HXDLIN( 148)		int _g = 0;
HXDLIN( 148)		 ::haxe::ui::core::Component _this = this->get_component();
HXDLIN( 148)		::Array< ::Dynamic> _g1;
HXDLIN( 148)		if (::hx::IsNull( _this->_children )) {
HXDLIN( 148)			_g1 = ::Array_obj< ::Dynamic>::__new(0);
            		}
            		else {
HXDLIN( 148)			_g1 = _this->_children;
            		}
HXDLIN( 148)		while((_g < _g1->length)){
HXDLIN( 148)			 ::haxe::ui::core::Component child = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 148)			_g = (_g + 1);
HXLINE( 149)			if ((child->get_includeInLayout() == false)) {
HXLINE( 150)				continue;
            			}
HXLINE( 153)			Float xpos = ( (Float)(0) );
HXLINE( 154)			Float ypos = ( (Float)(0) );
HXLINE( 156)			::String _hx_switch_0 = this->horizontalAlign(child);
            			if (  (_hx_switch_0==HX_("center",d5,25,db,05)) ){
HXLINE( 158)				 ::Dynamic xpos1 = this->get_component()->get_componentWidth();
HXDLIN( 158)				Float xpos2 = ((( (Float)(xpos1) ) - ( (Float)(child->get_componentWidth()) )) / ( (Float)(2) ));
HXDLIN( 158)				Float xpos3 = (xpos2 + this->marginLeft(child));
HXDLIN( 158)				xpos = (xpos3 - this->marginRight(child));
HXDLIN( 158)				goto _hx_goto_8;
            			}
            			if (  (_hx_switch_0==HX_("right",dc,0b,64,e9)) ){
HXLINE( 160)				 ::Dynamic xpos1 = this->get_component()->get_componentWidth();
HXDLIN( 160)				 ::Dynamic xpos2 = child->get_componentWidth();
HXDLIN( 160)				Float xpos3 = (xpos2 + this->get_paddingRight());
HXDLIN( 160)				xpos = (( (Float)(xpos1) ) - (xpos3 + this->marginRight(child)));
HXDLIN( 160)				goto _hx_goto_8;
            			}
            			/* default */{
HXLINE( 162)				Float xpos1 = this->get_paddingLeft();
HXDLIN( 162)				xpos = (xpos1 + this->marginLeft(child));
            			}
            			_hx_goto_8:;
HXLINE( 165)			::String _hx_switch_1 = this->verticalAlign(child);
            			if (  (_hx_switch_1==HX_("bottom",eb,e6,78,65)) ){
HXLINE( 169)				 ::Dynamic ypos1 = this->get_component()->get_componentHeight();
HXDLIN( 169)				 ::Dynamic ypos2 = child->get_componentHeight();
HXDLIN( 169)				Float ypos3 = (ypos2 + this->get_paddingBottom());
HXDLIN( 169)				ypos = (( (Float)(ypos1) ) - (ypos3 + this->marginBottom(child)));
HXDLIN( 169)				goto _hx_goto_9;
            			}
            			if (  (_hx_switch_1==HX_("center",d5,25,db,05)) ){
HXLINE( 167)				 ::Dynamic ypos1 = this->get_component()->get_componentHeight();
HXDLIN( 167)				Float ypos2 = ((( (Float)(ypos1) ) - ( (Float)(child->get_componentHeight()) )) / ( (Float)(2) ));
HXDLIN( 167)				Float ypos3 = (ypos2 + this->marginTop(child));
HXDLIN( 167)				ypos = (ypos3 - this->marginBottom(child));
HXDLIN( 167)				goto _hx_goto_9;
            			}
            			/* default */{
HXLINE( 171)				Float ypos1 = this->get_paddingTop();
HXDLIN( 171)				ypos = (ypos1 + this->marginTop(child));
            			}
            			_hx_goto_9:;
HXLINE( 174)			child->moveComponent(xpos,ypos);
            		}
            	}
