...
HX_DEFINE_STACK_FRAME(_hx_pos_8a41f2c13e073b75_13_new,"haxe.ui.events.AnimationEvent","new",0x4951f16b,"haxe.ui.events.AnimationEvent.new","haxe/ui/events/AnimationEvent.hx",13,0xb8ce69e4)
HX_LOCAL_STACK_FRAME(_hx_pos_8a41f2c13e073b75_16_clone,"haxe.ui.events.AnimationEvent","clone",0x65f3cd28,"haxe.ui.events.AnimationEvent.clone","haxe/ui/events/AnimationEvent.hx",16,0xb8ce69e4)
...
void AnimationEvent_obj::__construct(::String type){
            	HX_STACKFRAME(&_hx_pos_8a41f2c13e073b75_13_new)
HXDLIN(  13)		super::__construct(type,null(),null());
            	}
...
bool AnimationEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::events::UIEvent AnimationEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_8a41f2c13e073b75_16_clone)
HXLINE(  17)		 ::haxe::ui::events::AnimationEvent c =  ::haxe::ui::events::AnimationEvent_obj::__alloc( HX_CTX ,this->type);
HXLINE(  18)		c->currentTime = this->currentTime;
HXLINE(  19)		c->delta = this->delta;
HXLINE(  20)		c->position = this->position;
HXLINE(  21)		return c;
            	}
...
HXDLIN(   6)		FRAME = HX_("animationframe",a9,9a,79,83);
            	}
}
